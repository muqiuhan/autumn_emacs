;;; autumn-themes.el --- Highly accessible themes (WCAG AAA) -*- lexical-binding:t -*-

;; Copyright (C) 2019-2022 Free Software Foundation, Inc.

;; Author: Protesilaos Stavrou <info@protesilaos.com>
;; URL: https://gitlab.com/protesilaos/autumn-themes
;; Version: 1.6.0
...
;;; Commentary:
;;
;; The Autumn themes conform with the highest standard for color-contrast
...
;; themes, or available at: <https://protesilaos.com/autumn-themes>).
;;
;; The themes share the following customization variables:
;;
;;     autumn-themes-headings                       (alist)
;;     autumn-themes-org-agenda                     (alist)
;;     autumn-themes-bold-constructs                (boolean)
;;     autumn-themes-inhibit-reload                 (boolean)
;;     autumn-themes-italic-constructs              (boolean)
;;     autumn-themes-no-mixed-fonts                 (boolean)
;;     autumn-themes-scale-headings                 (boolean)
;;     autumn-themes-subtle-line-numbers            (boolean)
;;     autumn-themes-success-deuteranopia           (boolean)
;;     autumn-themes-variable-pitch-headings        (boolean)
;;     autumn-themes-variable-pitch-ui              (boolean)
;;     autumn-themes-completions                    (choice)
;;     autumn-themes-diffs                          (choice)
;;     autumn-themes-fringes                        (choice)
;;     autumn-themes-hl-line                        (choice)
;;     autumn-themes-lang-checkers                  (choice)
;;     autumn-themes-links                          (choice)
;;     autumn-themes-mail-citations                 (choice)
;;     autumn-themes-mode-line                      (choice)
;;     autumn-themes-org-blocks                     (choice)
;;     autumn-themes-paren-match                    (choice)
;;     autumn-themes-prompts                        (choice)
;;     autumn-themes-region                         (choice)
;;     autumn-themes-syntax                         (choice)
;;
;; The default scale for headings is as follows (it can be customized as
;; well---remember, no scaling takes place by default):
;;
;;     autumn-themes-scale-1                        1.05
;;     autumn-themes-scale-2                        1.1
;;     autumn-themes-scale-3                        1.15
;;     autumn-themes-scale-4                        1.2
;;     autumn-themes-scale-title                    1.3
;;
;; There is another scaling-related option, which however is reserved
;; for special cases and is not used for headings:
;;
;;     autumn-themes-scale-small                    0.9
;;
...
;; The symbols are:
;;
;;     autumn-themes-operandi-color-overrides       (alist)
;;     autumn-themes-vivendi-color-overrides        (alist)
;;
...
;; current item):
;;
;; - autumn-operandi-theme.el    (Light theme)
;; - autumn-vivendi-theme.el     (Dark theme)
...
(defgroup autumn-themes ()
  "Options for `autumn-operandi', `autumn-vivendi'.
The Autumn themes conform with the WCAG AAA standard for color
...
cover the blue-cyan-magenta side of the spectrum."
  :group 'faces
  :link '(info-link "(autumn-themes) Top")
  :prefix "autumn-themes-"
  :tag "Autumn Themes")

(defgroup autumn-themes-faces ()
  "Faces defined my `autumn-operandi' and `autumn-vivendi'."
  :group 'autumn-themes
  :link '(info-link "(autumn-themes) Top")
  :prefix "autumn-themes-"
  :tag "Autumn Themes Faces")

;;; Variables for each theme variant

;;;; Autumn Operandi

(defconst autumn-themes-operandi-colors
  '(;; base values
    ...
    ;; line-number
    (line-number-fg . "#ffffff")
    (line-number-bg . "#0000aa")
    (line-number-current-line-fg . "#ffffff")
    (line-number-current-line-bg . "#0000ff")

    ;; cursor
    (cursor-color . "#00ff00")
    )
  "The entire palette of the `autumn-operandi' theme.
Each element has the form (NAME . HEX) with the former as a
symbol and the latter as a string.")

;;;; Autumn Vivendi

(defconst autumn-themes-vivendi-colors
  '(;; base values
  ...
  "The entire palette of the `autumn-vivendi' theme.
Each element has the form (NAME . HEX) with the former as a
symbol and the latter as a string.")
...
;; options.
(defface autumn-themes-subtle-red nil
...
The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-subtle-green nil
...
(defface autumn-themes-subtle-yellow nil
...
(defface autumn-themes-subtle-blue nil
...
(defface autumn-themes-subtle-magenta nil
...
(defface autumn-themes-subtle-cyan nil
...
(defface autumn-themes-subtle-neutral nil
...
(defface autumn-themes-intense-red nil
...
(defface autumn-themes-intense-green nil
...
(defface autumn-themes-intense-yellow nil
...
(defface autumn-themes-intense-blue nil
...
(defface autumn-themes-intense-magenta nil
...
(defface autumn-themes-intense-cyan nil
...
(defface autumn-themes-intense-neutral nil
...
(defface autumn-themes-refine-red nil
...
(defface autumn-themes-refine-green nil
...
(defface autumn-themes-refine-yellow nil
...
(defface autumn-themes-refine-blue nil
...
(defface autumn-themes-refine-magenta nil
...
(defface autumn-themes-refine-cyan nil
...
(defface autumn-themes-active-red nil
...
(defface autumn-themes-active-green nil
...
(defface autumn-themes-active-yellow nil
...
(defface autumn-themes-active-blue nil
...
(defface autumn-themes-active-magenta nil
...
(defface autumn-themes-active-cyan nil
...
(defface autumn-themes-fringe-red nil
...
(defface autumn-themes-fringe-green nil
...
(defface autumn-themes-fringe-yellow nil
...
(defface autumn-themes-fringe-blue nil
...
(defface autumn-themes-fringe-magenta nil
...
(defface autumn-themes-fringe-cyan nil
...
(defface autumn-themes-nuanced-red nil
...
(defface autumn-themes-nuanced-green nil
...
(defface autumn-themes-nuanced-yellow nil
...
(defface autumn-themes-nuanced-blue nil
...
(defface autumn-themes-nuanced-magenta nil
...
(defface autumn-themes-nuanced-cyan nil
...
(defface autumn-themes-special-cold nil
...
(defface autumn-themes-special-mild nil
...
(defface autumn-themes-special-warm nil
...
(defface autumn-themes-special-calm nil
...
(defface autumn-themes-diff-added nil
...
(defface autumn-themes-diff-changed nil
...
(defface autumn-themes-diff-removed nil
...
(defface autumn-themes-diff-refine-added nil
...
(defface autumn-themes-diff-refine-changed nil
...
(defface autumn-themes-diff-refine-removed nil
...
(defface autumn-themes-diff-focus-added nil
...
(defface autumn-themes-diff-focus-changed nil
...
(defface autumn-themes-diff-focus-removed nil
...
(defface autumn-themes-diff-heading nil
...
(defface autumn-themes-pseudo-header nil
  "Generic style for some elements that function like headings.
The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-mark-alt nil
...
(defface autumn-themes-mark-del nil
...
(defface autumn-themes-mark-sel nil
...
(defface autumn-themes-mark-symbol nil
...
(defface autumn-themes-heading-1 nil
  "General purpose face for use in headings level 1.
The exact attributes assigned to this face are contingent on the
values assigned to the `autumn-themes-headings' variable.

The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-heading-2 nil
...
(defface autumn-themes-heading-3 nil
...
(defface autumn-themes-heading-4 nil
...
(defface autumn-themes-heading-5 nil
...
(defface autumn-themes-heading-6 nil
...
(defface autumn-themes-heading-7 nil
...
(defface autumn-themes-heading-8 nil
...
(defface autumn-themes-hl-line nil
  "General purpose face for the current line.
The exact attributes assigned to this face are contingent on the
values assigned to the `autumn-themes-hl-line' variable.

The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-bold nil
  "Generic face for applying a conditional bold weight.
This behaves in accordance with `autumn-themes-bold-constructs'.

The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-slant nil
  "Generic face for applying a conditional slant (italics).
This behaves in accordance with `autumn-themes-italic-constructs'.

The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-variable-pitch nil
  "Generic face for applying a conditional `variable-pitch'.
This behaves in accordance with `autumn-themes-no-mixed-fonts',
`autumn-themes-variable-pitch-headings' for all heading levels,
and `autumn-themes-variable-pitch-ui'.

The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-fixed-pitch nil
...
(defface autumn-themes-graph-red-0 nil
...
(defface autumn-themes-graph-red-1 nil
...
(defface autumn-themes-graph-green-0 nil
...
(defface autumn-themes-graph-green-1 nil
...
(defface autumn-themes-graph-yellow-0 nil
...
(defface autumn-themes-graph-yellow-1 nil
...
(defface autumn-themes-graph-blue-0 nil
...
(defface autumn-themes-graph-blue-1 nil
...
(defface autumn-themes-graph-magenta-0 nil
...
(defface autumn-themes-graph-magenta-1 nil
...
(defface autumn-themes-graph-cyan-0 nil
...
(defface autumn-themes-graph-cyan-1 nil
...
(defface autumn-themes-lang-error nil
...
(defface autumn-themes-reset-soft nil
...
see `autumn-themes-reset-hard'.

The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-reset-hard nil
  "Generic face to set all face properties to nil.

This is intended to be inherited by faces that should not retain
properties from their context (e.g. an overlay over an underlined
text should not be underlined as well) and not blend in.  Also
see `autumn-themes-reset-soft'.

The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-key-binding nil
  "Generic face for key bindings.
The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-search-success nil
  "Generic face for successful search.
The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-search-success-modeline nil
  "Generic mode line indicator for successful search.
The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-search-success-lazy nil
  "Generic face for successful, lazily highlighted search.
The actual styling of the face is done by `autumn-themes-faces'."
  :group 'autumn-theme-faces)

(defface autumn-themes-prompt nil
...
(defcustom autumn-themes-inhibit-reload t
...
reload the currently active Autumn theme.

Enable this behaviour by setting this variable to nil."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.5.0")
  :version "28.1"
  :type 'boolean
  :link '(info-link "(autumn-themes) Custom reload theme"))

(defun autumn-themes--set-option (sym val)
  "Custom setter for theme related user options.
Will set SYM to VAL, and reload the current theme, unless
`autumn-themes-inhibit-reload' is non-nil."
  (set-default sym val)
  (unless (or autumn-themes-inhibit-reload
    ...
    (let ((autumn-themes-inhibit-reload t))
      (pcase (autumn-themes--current-theme)
        ('autumn-operandi (autumn-themes-load-operandi))
        ('autumn-vivendi (autumn-themes-load-vivendi))))))

(defcustom autumn-themes-operandi-color-overrides nil
  "Override colors in the Autumn Operandi palette.

For form, see `autumn-themes-operandi-colors'."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.1.0")
  :version "28.1"
  :type '(alist :key-type symbol :value-type color)
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Override colors (DIY)"))

(defcustom autumn-themes-vivendi-color-overrides nil
  "Override colors in the Autumn Vivendi palette.

For form, see `autumn-themes-vivendi-colors'."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.1.0")
  :version "28.1"
  :type '(alist :key-type symbol :value-type color)
...
(let* ((names (mapcar (lambda (pair)
                      ...
                      autumn-themes-operandi-colors))
       (colors (mapcar #'intern (sort names #'string<))))
  (put 'autumn-themes-operandi-color-overrides
       'custom-options (copy-sequence colors))
  (put 'autumn-themes-vivendi-color-overrides
       'custom-options (copy-sequence colors)))

(define-obsolete-variable-alias
  'autumn-themes-slanted-constructs
  'autumn-themes-italic-constructs
  "1.5.0")

(defcustom autumn-themes-italic-constructs nil
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Italic constructs"))

(defcustom autumn-themes-bold-constructs nil
  "Use bold text in more code constructs."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.0.0")
  :version "28.1"
  :type 'boolean
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Bold constructs"))

(defcustom autumn-themes-variable-pitch-headings nil
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Headings' typeface"))

(defcustom autumn-themes-variable-pitch-ui nil
...
This includes the mode line, header line, tab bar, and tab line."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) UI typeface"))

(defcustom autumn-themes-no-mixed-fonts nil
...
mixing fonts."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) No mixed fonts"))

(defconst autumn-themes--headings-choice
  ...
  "Refer to the doc string of `autumn-themes-headings'.
This is a helper variable intended for internal use.")

(defcustom autumn-themes-headings nil
...
Also read `autumn-themes-scale-headings' to change the height of
headings and `autumn-themes-variable-pitch-headings' to make them
use a proportionately spaced font."
  ...
  :type `(alist
          :options ,(mapcar (lambda (el)
                              (list el autumn-themes--headings-choice))
                            '(1 2 3 4 5 6 7 8 t))
          :key-type symbol
          :value-type ,autumn-themes--headings-choice)
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Heading styles"))

(defcustom autumn-themes-org-agenda nil
...
- `scale-title' to increase height to `autumn-themes-scale-title'
...
- `scale-heading' increases the height of the date headings to
  the value of `autumn-themes-scale-1' (which is the first step in
...
- `scale-small' reduces the height of the entries to the value of
  the user option `autumn-themes-scale-small' (0.9 the height of
...
For example:
    ...
    (habit . traffic-light)"
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.6.0")
  :version "28.1"
  :type '(set
          (cons :tag "Block header"
                ...
                (set :tag "Header presentation" :greedy t
                     ...
                     (choice :tag "Scaling"
                             ...
                             (const :tag "Scale to match `autumn-themes-scale-title'" scale-title))))
          (cons :tag "Date header" :greedy t
                ...
                (set :tag "Header presentation" :greedy t
                     ...
                     (const :tag "Increase font size (`autumn-themes-scale-1')" scale-heading)
          ...
          (cons :tag "Event entry" :greedy t
                ...
                (set :tag "Text presentation" :greedy t
                     (const :tag "Use smaller font size (`autumn-themes-scale-small')" scale-small)
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Org agenda"))

(defcustom autumn-themes-scale-headings nil
  "Use font scaling for headings.

For regular headings the scale is controlled by the variables
`autumn-themes-scale-1' (smallest increase) and its variants all
the way up to `autumn-themes-scale-4' (largest increase).

While `autumn-themes-scale-title' is reserved for special headings
...
special heading."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.2.0")
  :version "28.1"
  :type 'boolean
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Scaled headings"))

(defcustom autumn-themes-scale-1 1.05
...
`text-scale-adjust'."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Scaled heading sizes"))

(defcustom autumn-themes-scale-2 1.1
  "Font size slightly larger than `autumn-themes-scale-1'.
...
(defcustom autumn-themes-scale-3 1.15
  "Font size slightly larger than `autumn-themes-scale-2'.
...
(defcustom autumn-themes-scale-4 1.2
  "Font size slightly larger than `autumn-themes-scale-3'.
...
(define-obsolete-variable-alias 'autumn-themes-scale-5 'autumn-themes-scale-title "1.5.0")

(defcustom autumn-themes-scale-title 1.3
  "Font size slightly larger than `autumn-themes-scale-4'.

This size is only used for 'special' top level headings, such as
Org's file title heading, denoted by the #+title key word, and
the Org agenda structure headers (see `autumn-themes-org-agenda').
...
(defcustom autumn-themes-scale-small 0.9
...
(defcustom autumn-themes-fringes nil
...
pronounced grayscale value."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Fringes"))

(defcustom autumn-themes-lang-checkers nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-lang-checkers '(text-also background))
...
`x-use-underline-position-properties'."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Language checkers"))

(defcustom autumn-themes-org-blocks nil
...
respectively."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.4.0")
  :version "28.1"
  :type '(choice
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Org mode blocks"))

(defcustom autumn-themes-org-habit nil
  "Deprecated in version 1.5.0 favor of `autumn-themes-org-agenda'.
...
highlights the alert and overdue states."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Org agenda habits"))

(make-obsolete 'autumn-themes-org-habit 'autumn-themes-org-agenda "1.5.0")

(defcustom autumn-themes-mode-line nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-mode-line '(borderless accented))
...
`x-underline-at-descent-line' to a non-nil value."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Mode line"))

(defcustom autumn-themes-diffs nil
...
interest of backward compatibility."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Diffs"))

(defcustom autumn-themes-completions nil
...
and `opinionated' possibilities."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Completion UIs"))

(defcustom autumn-themes-prompts nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-prompts '(background gray))"
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.5.0")
  :version "28.1"
  :type '(set :tag "Properties" :greedy t
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Command prompts"))

(defcustom autumn-themes-intense-hl-line nil
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Line highlighting"))

(make-obsolete 'autumn-themes-intense-hl-line 'autumn-themes-hl-line "1.3.0")

(defcustom autumn-themes-hl-line nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-hl-line '(underline accented))
...
(defcustom autumn-themes-subtle-line-numbers nil
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Line numbers"))

(defcustom autumn-themes-paren-match nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-paren-match '(bold intense))"
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.5.0")
  :version "28.1"
  :type '(set :tag "Properties" :greedy t
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Matching parentheses"))

(defcustom autumn-themes-syntax nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-syntax '(faint alt-syntax))

Independent of this variable, users may also control the use of a
bold weight or italic text: `autumn-themes-bold-constructs' and
`autumn-themes-italic-constructs'."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.5.0")
  :version "28.1"
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Syntax styles"))

(defcustom autumn-themes-links nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-links '(neutral-underline background))
...
Please refer to their documentation strings."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Link styles"))

(defcustom autumn-themes-region nil
...
In user configuration files the form may look like this:
    ...
    (setq autumn-themes-region '(bg-only no-extend))"
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.5.0")
  :version "28.1"
  :type '(set :tag "Properties" :greedy t
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Active region"))

(defcustom autumn-themes-success-deuteranopia nil
...
configured to conform with deuteranopia: `autumn-themes-diffs'."
  :group 'autumn-themes
  :package-version '(autumn-themes . "1.4.0")
  :version "28.1"
  :type 'boolean
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Success' color-code"))

(defcustom autumn-themes-mail-citations nil
...
colored into a uniform shade of shade of gray."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Mail citations"))

(defcustom autumn-themes-tabs-accented nil
...
as the Centaur tabs package."
  ...
  :set #'autumn-themes--set-option
  :initialize #'custom-initialize-default
  :link '(info-link "(autumn-themes) Tab style"))



;;; Internal functions

(defun autumn-themes--palette (theme)
  "Return color palette for Autumn theme THEME.
THEME is a symbol, either `autumn-operandi' or `autumn-vivendi'."
  (pcase theme
    ('autumn-operandi
     (append autumn-themes-operandi-color-overrides
             autumn-themes-operandi-colors))
    ('autumn-vivendi
     (append autumn-themes-vivendi-color-overrides
             autumn-themes-vivendi-colors))
    (_theme
     (error "'%s' is not a Autumn theme" theme))))

(defvar autumn-themes-faces)
(defvar autumn-themes-custom-variables)

(defmacro autumn-themes-theme (name)
  "Bind NAME's color palette around face specs and variables.

NAME should be the proper name of a Autumn theme, either
`autumn-operandi' or `autumn-vivendi'.

Face specifications are passed to `custom-theme-set-faces'.
While variables are handled by `custom-theme-set-variables'.
Those are stored in `autumn-themes-faces' and
`autumn-themes-custom-variables' respectively."
  (declare (indent 0))
  (let ((palette-sym (gensym))
        (colors (mapcar #'car autumn-themes-operandi-colors)))
    `(let* ((class '((class color) (min-colors 89)))
            (,palette-sym (autumn-themes--palette ',name))
            ,@(mapcar (lambda (color)
                        (list color `(alist-get ',color ,palette-sym)))
                      colors))
       (custom-theme-set-faces ',name ,@autumn-themes-faces)
       (custom-theme-set-variables ',name ,@autumn-themes-custom-variables))))

(defun autumn-themes--current-theme ()
  "Return current theme."
  (car custom-enabled-themes))

;; Helper functions that are meant to ease the implementation of the
;; above customization variables.
(defun autumn-themes--bold-weight ()
  "Conditional use of a heavier text weight."
  (when autumn-themes-bold-constructs
    (list :inherit 'bold)))

(defun autumn-themes--slant ()
  "Conditional use of italics for slant attribute."
  (if autumn-themes-italic-constructs
      (list 'italic)
    (list 'normal)))

(defun autumn-themes--fixed-pitch ()
  "Conditional application of `fixed-pitch' inheritance."
  (unless autumn-themes-no-mixed-fonts
    (list :inherit 'fixed-pitch)))

(defun autumn-themes--variable-pitch ()
  "Conditional use of `variable-pitch' in headings."
  (when autumn-themes-variable-pitch-headings
    (list :inherit 'variable-pitch)))

(defun autumn-themes--variable-pitch-ui ()
  "Conditional use of `variable-pitch' in UI elements."
  (when autumn-themes-variable-pitch-ui
    (list :inherit 'variable-pitch)))

(defun autumn-themes--fringe (mainbg subtlebg intensebg)
...
value.  INTENSEBG must be a more pronounced grayscale color."
  (pcase autumn-themes-fringes
    ('intense (list :background intensebg))
    ('subtle (list :background subtlebg))
    (_ (list :background mainbg))))

(defun autumn-themes--line-numbers (mainfg mainbg altfg &optional altbg)
...
combines with the theme's primary background (white/black)."
  (if autumn-themes-subtle-line-numbers
      (list :background (or altbg 'unspecified) :foreground altfg)
    (list :background mainbg :foreground mainfg)))

(defun autumn-themes--lang-check (underline subtlefg intensefg intensefg-alt subtlebg intensebg)
...
differ in overall intensity."
  (let ((autumn-themes-lang-checkers
         (if (listp autumn-themes-lang-checkers)
             autumn-themes-lang-checkers
           (pcase autumn-themes-lang-checkers
    ...
    (list :underline
          (list :color
                underline
                :style
                (if (memq 'straight-underline autumn-themes-lang-checkers)
                    'line 'wave))
          :background
          (cond
           ((and (memq 'background autumn-themes-lang-checkers)
                 (memq 'intense autumn-themes-lang-checkers))
            intensebg)
           ((memq 'background autumn-themes-lang-checkers)
            subtlebg))
          :foreground
          (cond
           ((and (memq 'background autumn-themes-lang-checkers)
           ...
           ((memq 'intense autumn-themes-lang-checkers)
            intensefg)
           ((memq 'text-also autumn-themes-lang-checkers)
            subtlefg)))))

(defun autumn-themes--prompt (mainfg intensefg grayfg subtlebg intensebg intensebg-fg subtlebggray intensebggray)
...
theme's fallback text color."
  (let ((autumn-themes-prompts
         (if (listp autumn-themes-prompts)
             autumn-themes-prompts
           ;; translation layer for legacy values
           (pcase autumn-themes-prompts
    ...
    (list :foreground
          (cond
           ((and (memq 'gray autumn-themes-prompts)
                 (memq 'intense autumn-themes-prompts))
            'unspecified)
           ((memq 'gray autumn-themes-prompts)
            grayfg)
           ((and (memq 'background autumn-themes-prompts)
                 (memq 'intense autumn-themes-prompts))
            intensebg-fg)
           ((memq 'intense autumn-themes-prompts)
            intensefg)
          ...
          (cond
           ((and (memq 'gray autumn-themes-prompts)
                 (memq 'background autumn-themes-prompts)
                 (memq 'intense autumn-themes-prompts))
            intensebggray)
           ((and (memq 'gray autumn-themes-prompts)
                 (memq 'background autumn-themes-prompts))
          ...
          :inherit
          (cond
           ((and (memq 'bold autumn-themes-prompts)
                 (memq 'italic autumn-themes-prompts))
            'bold-italic)
           ((memq 'italic autumn-themes-prompts)
            'italic)
           ((memq 'bold autumn-themes-prompts)
            'bold)
           ('unspecified)))))

(defun autumn-themes--paren (normalbg intensebg)
...
'bg-paren-match-intense'."
  (let ((autumn-themes-paren-match
         (if (listp autumn-themes-paren-match)
             autumn-themes-paren-match
           ;; translation layer for legacy values
           (pcase autumn-themes-paren-match
             ;; `subtle' is the same as `subtle-accented', while `intense' is
             ;; equal to `intense-accented' for backward compatibility
             ...
             ('intense '(intense))))))
    (list :inherit
          (if (memq 'bold autumn-themes-paren-match)
              'bold
            'unspecified)
          :background
          (if (memq 'intense autumn-themes-paren-match)
              intensebg
            normalbg)
          :underline
          (if (memq 'underline autumn-themes-paren-match)
              t
            nil))))

(defun autumn-themes--syntax-foreground (fg faint)
  "Apply foreground value to code syntax.
FG is the default.  FAINT is typically the same color in its
desaturated version."
  (let ((autumn-themes-syntax
         (if (listp autumn-themes-syntax)
             autumn-themes-syntax
           ;; translation layer for legacy values
           (pcase autumn-themes-syntax
             ('faint '(faint))
    ...
    (list :foreground
          (cond
           ((memq 'faint autumn-themes-syntax)
            faint)
           (fg)))))

(defun autumn-themes--syntax-extra (fg faint alt &optional faint-alt)
  "Apply foreground value to code syntax.
FG is the default.  FAINT is typically the same color in its
...
is its subtle alternative."
  (let ((autumn-themes-syntax
    ...
    (list :foreground
          (cond
           ((and (memq 'alt-syntax autumn-themes-syntax)
                 (memq 'faint autumn-themes-syntax))
            (or faint-alt alt))
           ((memq 'faint autumn-themes-syntax)
            faint)
           ((memq 'alt-syntax autumn-themes-syntax)
            alt)
           (fg)))))

(defun autumn-themes--syntax-string (fg faint green alt &optional faint-green faint-alt)
...
alternative to ALT."
  (let ((autumn-themes-syntax
    ...
    (list :foreground
          (cond
           ((and (memq 'faint autumn-themes-syntax)
                 (memq 'green-strings autumn-themes-syntax))
...
(defun autumn-themes--syntax-comment (fg yellow &optional faint-yellow faint)
  "Apply foreground value to strings in code syntax.
...
an alternative to the default value."
  (let ((autumn-themes-syntax
    ...
    (list :foreground
          (cond
           ((and (memq 'faint autumn-themes-syntax)
                 (memq 'yellow-comments autumn-themes-syntax))
            (or faint-yellow yellow))
           ((and (memq 'alt-syntax autumn-themes-syntax)
                 (memq 'yellow-comments autumn-themes-syntax)
                 (not (memq 'green-strings autumn-themes-syntax)))
            (or faint-yellow yellow))
           ((memq 'yellow-comments autumn-themes-syntax)
            yellow)
           ((memq 'faint autumn-themes-syntax)
...
(defun autumn-themes--key-cdr (key alist)
  "Get cdr of KEY in ALIST."
  (cdr (assoc key alist)))

(defun autumn-themes--heading (level fg fg-alt bg bg-gray border)
  "Conditional styles for `autumn-themes-headings'.
...
that combines well with the background and foreground."
  (let* ((key (autumn-themes--key-cdr level autumn-themes-headings))
         (style (or key (autumn-themes--key-cdr t autumn-themes-headings)))
         (autumn-themes-headings
          (if (listp style)
              style
            ;; translation layer for legacy values
            (pcase style
         ...
         (var (if autumn-themes-variable-pitch-headings
                  'variable-pitch
                'unspecified))
         (varbold (if var
    ...
    (list :inherit
          (cond
           ((memq 'no-bold autumn-themes-headings)
            var)
           (varbold))
          :background
          (cond
           ((and (memq 'monochrome autumn-themes-headings)
                 (memq 'background autumn-themes-headings))
            bg-gray)
           ((memq 'background autumn-themes-headings)
            bg)
           ('unspecified))
          :foreground
          (cond
           ((memq 'monochrome autumn-themes-headings)
            'unspecified)
           ((memq 'rainbow autumn-themes-headings)
            fg-alt)
           (fg))
          :overline
          (if (memq 'overline autumn-themes-headings)
              border
            'unspecified))))

(defun autumn-themes--agenda-structure (fg)
  "Control the style of the Org agenda structure.
FG is the foreground color to use."
  (let* ((properties (autumn-themes--key-cdr 'header-block autumn-themes-org-agenda))
         ...
         (height (cond ((memq 'no-scale properties)
                       ...
                       ((memq 'scale-title properties)
                        autumn-themes-scale-title)
                       (1.15))))
    (list :inherit inherit
          :height height
          :foreground fg)))

(defun autumn-themes--agenda-date (defaultfg grayscalefg &optional workaholicfg grayscaleworkaholicfg bg bold ul)
...
weight.  Optional UL applies an underline."
  (let ((properties (autumn-themes--key-cdr 'header-date autumn-themes-org-agenda)))
    (list :inherit
          (cond
...
(defun autumn-themes--agenda-event (fg)
  "Control the style of the Org agenda events.
FG is the accent color to use."
  (let ((properties (autumn-themes--key-cdr 'event autumn-themes-org-agenda)))
    (list :height
          (if (memq 'scale-small properties)
              autumn-themes-scale-small
            'unspecified)
          :foreground
...
(defun autumn-themes--agenda-scheduled (defaultfg uniformfg rainbowfg)
...
clearly distinguishes past, present, future tasks."
  (pcase (autumn-themes--key-cdr 'scheduled autumn-themes-org-agenda)
    ('uniform (list :foreground uniformfg))
    ('rainbow (list :foreground rainbowfg))
    (_ (list :foreground defaultfg))))

(defun autumn-themes--agenda-habit (default traffic simple &optional traffic-deuteran)
  "Specify background values for `autumn-themes-org-agenda' habits.
...
is an alternative to TRAFFIC, meant for deuteranopia."
  (pcase (autumn-themes--key-cdr 'habit autumn-themes-org-agenda)
...
(defun autumn-themes--org-block (bgblk fgdefault &optional fgblk)
...
`autumn-themes-org-blocks' also accepts `tinted-background' (alias
`rainbow') as a value which applies to `org-src-block-faces' (see
the theme's source code)."
  (if (or (eq autumn-themes-org-blocks 'gray-background)
          (eq autumn-themes-org-blocks 'grayscale)
          (eq autumn-themes-org-blocks 'greyscale))
      (list :background bgblk :foreground (or fgblk fgdefault) :extend t)
    (list :background 'unspecified :foreground fgdefault)))

(defun autumn-themes--org-block-delim (bgaccent fgaccent bg fg)
...
default styles or when `autumn-themes-org-blocks' is set
to `grayscale' (or `greyscale').

The latter pair should be more subtle than the background of the
block, as it is used when `autumn-themes-org-blocks' is
set to `rainbow'."
  (pcase autumn-themes-org-blocks
...
property."
  (let ((autumn-themes-mode-line
         (if (listp autumn-themes-mode-line)
             autumn-themes-mode-line
           ;; translation layer for legacy values
           (alist-get autumn-themes-mode-line
                      '((3d . (3d))
                        (moody . (moody))
    ...
    (let ((base (cond ((memq 'accented autumn-themes-mode-line)
                       (cons fg-accent bg-accent))
                      ((and (or (memq 'moody autumn-themes-mode-line)
                                (memq '3d autumn-themes-mode-line))
                            (not (memq 'borderless autumn-themes-mode-line)))
                       (cons fg-alt bg-alt))
                      ((cons fg bg))))
          (box (cond ((memq 'moody autumn-themes-mode-line)
                      nil)
                     ((and (memq '3d autumn-themes-mode-line)
                           (memq 'padded autumn-themes-mode-line))
                      (list :line-width 4
                            :color
                            (cond ((and (memq 'accented autumn-themes-mode-line)
                                        (memq 'borderless autumn-themes-mode-line))
                                   bg-accent)
                                  ((or (memq 'accented autumn-themes-mode-line)
                                       (memq 'borderless autumn-themes-mode-line))
                                   bg)
                                  (bg-alt))
                            :style (when alt-style 'released-button)))
                     ((and (memq 'accented autumn-themes-mode-line)
                           (memq 'padded autumn-themes-mode-line))
                     ...
                     ((memq '3d autumn-themes-mode-line)
                      (list :line-width 1
                            ...
                            (cond ((and (memq 'accented autumn-themes-mode-line)
                                        (memq 'borderless autumn-themes-mode-line))
                                   bg-accent)
                                  ((memq 'borderless autumn-themes-mode-line) bg)
                                  (border-3d))
                            :style (when alt-style 'released-button)))
                     ((memq 'borderless autumn-themes-mode-line)
                      bg)
                     ((memq 'padded autumn-themes-mode-line)
                      (list :line-width 6 :color bg))
                     (border)))
          (line (cond ((not (or (memq 'moody autumn-themes-mode-line)
                                (memq 'padded autumn-themes-mode-line)))
                       nil)
                      ((and (memq 'borderless autumn-themes-mode-line)
                            (memq 'accented autumn-themes-mode-line))
                       bg-accent)
                      ((memq 'borderless autumn-themes-mode-line)
                       bg)
                      (border))))
      (list :foreground (car base)
            ...
            :underline line
            :distant-foreground
            (when (memq 'moody autumn-themes-mode-line)
              fg-distant)))))

(defun autumn-themes--diff
    (fg-only-bg fg-only-fg mainbg mainfg altbg altfg &optional deuteranbg deuteranfg  bg-only-fg)
  "Color combinations for `autumn-themes-diffs'.
...
(defun autumn-themes--diff-deuteran (deuteran main)
  "Determine whether the DEUTERAN or MAIN color should be used.
This is based on whether `autumn-themes-diffs' has the value
`deuteranopia'."
  (if (or (eq autumn-themes-diffs 'deuteranopia)
          (eq autumn-themes-diffs 'fg-only-deuteranopia)
          (eq autumn-themes-diffs 'fg-only))
      (list deuteran)
    (list main)))

(defun autumn-themes--success-deuteran (deuteran main)
  "Determine whether to color-code success as DEUTERAN or MAIN."
  (if autumn-themes-success-deuteranopia
      (list deuteran)
    (list main)))

(defun autumn-themes--standard-completions (mainfg subtlebg intensebg intensefg)
  "Combinations for `autumn-themes-completions'.
...
These are intended for Icomplete, Ido, and related."
  (pcase autumn-themes-completions
...
(defun autumn-themes--extra-completions (subtleface intenseface altface &optional altfg bold)
  "Combinations for `autumn-themes-completions'.
...
(defun autumn-themes--link (fg fgfaint underline bg bgneutral)
...
is a background color and BGNEUTRAL is its fallback value."
  (let ((autumn-themes-links
         (if (listp autumn-themes-links)
             autumn-themes-links
           ;; translation layer for legacy values
           (pcase autumn-themes-links
             ('faint '(faint))
    ...
    (list :inherit
          (cond
           ((and (memq 'bold autumn-themes-links)
                 (memq 'italic autumn-themes-links))
            'bold-italic)
           ((memq 'italic autumn-themes-links)
            'italic)
           ((memq 'bold autumn-themes-links)
            'bold)
           ('unspecified))
          :background
          (cond
           ((and (memq 'no-color autumn-themes-links)
                 (memq 'no-underline autumn-themes-links))
            bgneutral)
           ((memq 'background autumn-themes-links)
            bg)
           ('unspecified))
          :foreground
          (cond
           ((memq 'no-color autumn-themes-links)
            'unspecified)
           ((memq 'faint autumn-themes-links)
            fgfaint)
           (fg))
          :underline
          (cond
           ((memq 'no-underline autumn-themes-links)
            'unspecified)
           ((memq 'neutral-underline autumn-themes-links)
            underline)
           (t)))))

(defun autumn-themes--link-color (fg fgfaint &optional neutralfg)
  "Extends `autumn-themes--link'.
...
(defun autumn-themes--scale (amount)
  "Scale heading by AMOUNT.
AMOUNT is a customization option."
  (when autumn-themes-scale-headings
    (list :height amount)))

(defun autumn-themes--region (bg fg bgsubtle bgaccent bgaccentsubtle)
  "Apply `autumn-themes-region' styles.
...
combined with all colors used to fontify text."
  (let ((autumn-themes-region
         (if (listp autumn-themes-region)
             autumn-themes-region
           ;; translation layer for legacy values
           (pcase autumn-themes-region
             ('bg-only '(bg-only))
    ...
    (list :background
          (cond
           ((and (memq 'accented autumn-themes-region)
                 (memq 'bg-only autumn-themes-region))
            bgaccentsubtle)
           ((memq 'accented autumn-themes-region)
            bgaccent)
           ((memq 'bg-only autumn-themes-region)
            bgsubtle)
           (bg))
...
more prominent alternatives."
  (let ((autumn-themes-hl-line
         (if (listp autumn-themes-hl-line)
             autumn-themes-hl-line
           ;; translation layer for legacy values
           (pcase autumn-themes-hl-line
             ('intense-background '(intense))
    ...
    (list :background
          (cond
           ((and (memq 'intense autumn-themes-hl-line)
                 (memq 'accented autumn-themes-hl-line))
            bgaccent)
           ((memq 'accented autumn-themes-hl-line)
            bgaccentsubtle)
           ((memq 'intense autumn-themes-hl-line)
            bgintense)
           (bgdefault))
          :underline
          (cond
           ((and (memq 'intense autumn-themes-hl-line)
                 (memq 'accented autumn-themes-hl-line)
                 (memq 'underline autumn-themes-hl-line))
            lineaccentintense)
           ((and (memq 'accented autumn-themes-hl-line)
                 (memq 'underline autumn-themes-hl-line))
            lineaccent)
           ((and (memq 'intense autumn-themes-hl-line)
                 (memq 'underline autumn-themes-hl-line))
            lineneutralintense)
           ((or (memq 'no-background autumn-themes-hl-line)
                (memq 'underline autumn-themes-hl-line))
            lineneutral)
           ('unspecified)))))

(defun autumn-themes--mail-cite (mainfg subtlefg)
  "Combinations for `autumn-themes-mail-citations'.

MAINFG is an accented foreground value.  SUBTLEFG is its
desaturated counterpart."
  (pcase autumn-themes-mail-citations
    ('monochrome (list :inherit 'shadow))
    ('faint (list :foreground subtlefg))
    ('desaturated (list :foreground subtlefg))
    (_ (list :foreground mainfg))))

(defun autumn-themes--tab (bg &optional bgaccent fg fgaccent box-p bold-p var-p)
...
application of a variable-pitch font."
  (let ((background (if autumn-themes-tabs-accented (or bgaccent bg) bg))
        (foreground (if autumn-themes-tabs-accented (or fgaccent fg) fg)))
    (list
     :inherit (cond
               ((and bold-p var-p)
                (if autumn-themes-variable-pitch-ui
                    '(variable-pitch bold)
                  '(bold)))
               (bold-p 'bold)
               (var-p (when autumn-themes-variable-pitch-ui 'variable-pitch))
               ('unspecified))
...
(defun autumn-themes-wcag-formula (hex)
  "Get WCAG value of color value HEX.
The value is defined in hexadecimal RGB notation, such as those in
`autumn-themes-operandi-colors' and `autumn-themes-vivendi-colors'."
...
;;;###autoload
(defun autumn-themes-contrast (c1 c2)
  "Measure WCAG contrast ratio between C1 and C2.
C1 and C2 are color values written in hexadecimal RGB."
  (let ((ct (/ (+ (autumn-themes-wcag-formula c1) 0.05)
               (+ (autumn-themes-wcag-formula c2) 0.05))))
    (max ct (/ ct))))

(defun autumn-themes-current-palette ()
  "Return current color palette."
  (autumn-themes--palette (autumn-themes--current-theme)))

;;;###autoload
(defun autumn-themes-color (color)
  "Return color value for COLOR from current palette.
COLOR is a key in `autumn-themes-operandi-colors' or
`autumn-themes-vivendi-colors'."
  (alist-get color (autumn-themes-current-palette)))

;;;###autoload
(defun autumn-themes-color-alts (light-color dark-color)
  "Return color value from current palette.
When Autumn Operandi is enabled, return color value for color
LIGHT-COLOR.  When Autumn Vivendi is enabled, return color value
for DARK-COLOR.  LIGHT-COLOR and DARK-COLOR are keys in
`autumn-themes-operandi-colors' or `autumn-themes-vivendi-colors'."
  (let* ((theme (autumn-themes--current-theme))
         (color (pcase theme
                  ('autumn-operandi light-color)
                  ('autumn-vivendi dark-color)
                  (_theme
                   (error "'%s' is not a Autumn theme" theme)))))
    (alist-get color (autumn-themes--palette theme))))

(defmacro autumn-themes-with-colors (&rest body)
  "Evaluate BODY with colors from current palette bound.
For colors bound, see `autumn-themes-operandi-colors' or
`autumn-themes-vivendi-colors'."
  (declare (indent 0))
  (let ((palette-sym (gensym))
        (colors (mapcar #'car autumn-themes-operandi-colors)))
    `(let* ((class '((class color) (min-colors 89)))
            (,palette-sym (autumn-themes-current-palette))
            ,@(mapcar (lambda (color)
                        (list color `(alist-get ',color ,palette-sym)))
                      colors))
...
;;;###autoload
(defun autumn-themes-load-themes ()
  "Ensure that the Autumn themes are in `custom-enabled-themes'.
...
like `autumn-themes-toggle' or `autumn-themes-load-operandi', will
continue to work as intended even if they are lazy-loaded (such
as when they are declared in the `:config' phase)."
  (unless (or (custom-theme-p 'autumn-operandi)
              (custom-theme-p 'autumn-vivendi))
    (load-theme 'autumn-operandi t t)
    (load-theme 'autumn-vivendi t t)))

(defvar autumn-themes-after-load-theme-hook nil
  "Hook that runs after the `autumn-themes-toggle' routines.")
...
;; including the likes of `autumn-themes-operandi-color-overrides'.
;;
...
;; something like this:
;;
;; (defun autumn-themes-toggle-enabled ()
;;   "Toggle between `autumn-operandi' and `autumn-vivendi' themes."
;;   (interactive)
;;   (pcase (autumn-themes--current-theme)
;;     ('autumn-operandi (progn (enable-theme 'autumn-vivendi)
;;                             (disable-theme 'autumn-operandi)))
;;     ('autumn-vivendi (progn (enable-theme 'autumn-operandi)
;;                             (disable-theme 'autumn-vivendi)))
;;     (_ (error "No Autumn theme is loaded; evaluate `autumn-themes-load-themes' first"))))

;;;###autoload
(defun autumn-themes-load-operandi ()
  "Load `autumn-operandi' and disable `autumn-vivendi'.
Also run `autumn-themes-after-load-theme-hook'."
  (disable-theme 'autumn-vivendi)
  (load-theme 'autumn-operandi t)
  (run-hooks 'autumn-themes-after-load-theme-hook))

;;;###autoload
(defun autumn-themes-load-vivendi ()
  "Load `autumn-vivendi' and disable `autumn-operandi'.
Also run `autumn-themes-after-load-theme-hook'."
  (disable-theme 'autumn-operandi)
  (load-theme 'autumn-vivendi t)
  (run-hooks 'autumn-themes-after-load-theme-hook))

(defun autumn-themes--load-prompt ()
  "Helper for `autumn-themes-toggle'."
  (let ((theme
         (intern
          (completing-read "Load Autumn theme (will disable all others): "
                           '(autumn-operandi autumn-vivendi) nil t))))
...
;;;###autoload
(defun autumn-themes-toggle ()
  "Toggle between `autumn-operandi' and `autumn-vivendi' themes.
Also runs `autumn-themes-after-load-theme-hook' at its last stage
by virtue of calling either of `autumn-themes-load-operandi' and
`autumn-themes-load-vivendi' functions."
  (interactive)
  (autumn-themes-load-themes)
  (pcase (autumn-themes--current-theme)
    ('autumn-operandi (autumn-themes-load-vivendi))
    ('autumn-vivendi (autumn-themes-load-operandi))
    (_ (autumn-themes--load-prompt))))



;;;; Face specifications

(defconst autumn-themes-faces
  '(
;;;; custom faces
    ;; these bespoke faces are inherited by other constructs below
;;;;; subtle colored backgrounds
    `(autumn-themes-subtle-red ((,class :background ,red-subtle-bg :foreground ,fg-dim)))
    `(autumn-themes-subtle-green ((,class :background ,green-subtle-bg :foreground ,fg-dim)))
    `(autumn-themes-subtle-yellow ((,class :background ,yellow-subtle-bg :foreground ,fg-dim)))
    `(autumn-themes-subtle-blue ((,class :background ,blue-subtle-bg :foreground ,fg-dim)))
    `(autumn-themes-subtle-magenta ((,class :background ,magenta-subtle-bg :foreground ,fg-dim)))
    `(autumn-themes-subtle-cyan ((,class :background ,cyan-subtle-bg :foreground ,fg-dim)))
    `(autumn-themes-subtle-neutral ((,class :background ,bg-inactive :foreground ,fg-inactive)))
;;;;; intense colored backgrounds
    `(autumn-themes-intense-red ((,class :background ,red-intense-bg :foreground ,fg-main)))
    `(autumn-themes-intense-green ((,class :background ,green-intense-bg :foreground ,fg-main)))
    `(autumn-themes-intense-yellow ((,class :background ,yellow-intense-bg :foreground ,fg-main)))
    `(autumn-themes-intense-blue ((,class :background ,blue-intense-bg :foreground ,fg-main)))
    `(autumn-themes-intense-magenta ((,class :background ,magenta-intense-bg :foreground ,fg-main)))
    `(autumn-themes-intense-cyan ((,class :background ,cyan-intense-bg :foreground ,fg-main)))
    `(autumn-themes-intense-neutral ((,class :background ,bg-active :foreground ,fg-main)))
;;;;; refined background and foreground combinations
    ;; general purpose styles that use an accented foreground against an
    ;; accented background
    `(autumn-themes-refine-red ((,class :background ,red-refine-bg :foreground ,red-refine-fg)))
    `(autumn-themes-refine-green ((,class :background ,green-refine-bg :foreground ,green-refine-fg)))
    `(autumn-themes-refine-yellow ((,class :background ,yellow-refine-bg :foreground ,yellow-refine-fg)))
    `(autumn-themes-refine-blue ((,class :background ,blue-refine-bg :foreground ,blue-refine-fg)))
    `(autumn-themes-refine-magenta ((,class :background ,magenta-refine-bg :foreground ,magenta-refine-fg)))
    `(autumn-themes-refine-cyan ((,class :background ,cyan-refine-bg :foreground ,cyan-refine-fg)))
;;;;; "active" combinations, mostly for use on the mode line
    `(autumn-themes-active-red ((,class :background ,red-active :foreground ,bg-active)))
    `(autumn-themes-active-green ((,class :background ,green-active :foreground ,bg-active)))
    `(autumn-themes-active-yellow ((,class :background ,yellow-active :foreground ,bg-active)))
    `(autumn-themes-active-blue ((,class :background ,blue-active :foreground ,bg-active)))
    `(autumn-themes-active-magenta ((,class :background ,magenta-active :foreground ,bg-active)))
    `(autumn-themes-active-cyan ((,class :background ,cyan-active :foreground ,bg-active)))
;;;;; nuanced backgrounds
    ...
    `(autumn-themes-nuanced-red ((,class :background ,red-nuanced-bg :extend t)))
    `(autumn-themes-nuanced-green ((,class :background ,green-nuanced-bg :extend t)))
    `(autumn-themes-nuanced-yellow ((,class :background ,yellow-nuanced-bg :extend t)))
    `(autumn-themes-nuanced-blue ((,class :background ,blue-nuanced-bg :extend t)))
    `(autumn-themes-nuanced-magenta ((,class :background ,magenta-nuanced-bg :extend t)))
    `(autumn-themes-nuanced-cyan ((,class :background ,cyan-nuanced-bg :extend t)))
;;;;; fringe-specific combinations
    `(autumn-themes-fringe-red ((,class :background ,red-fringe-bg :foreground ,fg-main)))
    `(autumn-themes-fringe-green ((,class :background ,green-fringe-bg :foreground ,fg-main)))
    `(autumn-themes-fringe-yellow ((,class :background ,yellow-fringe-bg :foreground ,fg-main)))
    `(autumn-themes-fringe-blue ((,class :background ,blue-fringe-bg :foreground ,fg-main)))
    `(autumn-themes-fringe-magenta ((,class :background ,magenta-fringe-bg :foreground ,fg-main)))
    `(autumn-themes-fringe-cyan ((,class :background ,cyan-fringe-bg :foreground ,fg-main)))
;;;;; special base values
    ...
    `(autumn-themes-special-cold ((,class :background ,bg-special-cold :foreground ,fg-special-cold)))
    `(autumn-themes-special-mild ((,class :background ,bg-special-mild :foreground ,fg-special-mild)))
    `(autumn-themes-special-warm ((,class :background ,bg-special-warm :foreground ,fg-special-warm)))
    `(autumn-themes-special-calm ((,class :background ,bg-special-calm :foreground ,fg-special-calm)))
;;;;; diff-specific combinations
    ;; intended for `diff-mode' or equivalent
    `(autumn-themes-diff-added
      ((,class ,@(autumn-themes--diff
                  bg-main blue-alt-other
                  bg-diff-focus-added fg-diff-focus-added
                  green-nuanced-bg fg-diff-added
                  bg-diff-focus-added-deuteran fg-diff-focus-added-deuteran))))
    `(autumn-themes-diff-changed
      ((,class ,@(autumn-themes--diff
                  bg-main yellow
                  bg-diff-focus-changed fg-diff-focus-changed
                  yellow-nuanced-bg fg-diff-changed))))
    `(autumn-themes-diff-removed
      ((,class ,@(autumn-themes--diff
                  bg-main red
                  bg-diff-focus-removed fg-diff-focus-removed
                  red-nuanced-bg fg-diff-removed))))
    `(autumn-themes-diff-refine-added
      ((,class ,@(autumn-themes--diff
                  bg-diff-added-deuteran fg-diff-added-deuteran
                  bg-diff-refine-added fg-diff-refine-added
                  bg-diff-focus-added fg-diff-focus-added
                  bg-diff-refine-added-deuteran fg-diff-refine-added-deuteran))))
    `(autumn-themes-diff-refine-changed
      ((,class ,@(autumn-themes--diff
                  bg-diff-changed fg-diff-changed
                  bg-diff-refine-changed fg-diff-refine-changed
                  bg-diff-focus-changed fg-diff-focus-changed))))
    `(autumn-themes-diff-refine-removed
      ((,class ,@(autumn-themes--diff
                  bg-diff-removed fg-diff-removed
                  bg-diff-refine-removed fg-diff-refine-removed
                  bg-diff-focus-removed fg-diff-focus-removed))))
    `(autumn-themes-diff-focus-added
      ((,class ,@(autumn-themes--diff
                  bg-dim blue-alt-other
                  bg-diff-focus-added fg-diff-focus-added
                  bg-diff-added fg-diff-added
                  bg-diff-focus-added-deuteran fg-diff-focus-added-deuteran))))
    `(autumn-themes-diff-focus-changed
      ((,class ,@(autumn-themes--diff
                  bg-dim yellow
                  bg-diff-focus-changed fg-diff-focus-changed
                  bg-diff-changed fg-diff-changed))))
    `(autumn-themes-diff-focus-removed
      ((,class ,@(autumn-themes--diff
                  bg-dim red
                  bg-diff-focus-removed fg-diff-focus-removed
                  bg-diff-removed fg-diff-removed))))
    `(autumn-themes-diff-heading
      ((,class ,@(autumn-themes--diff
                  bg-alt fg-main
...
;;;;; mark indicators
    ...
    `(autumn-themes-pseudo-header ((,class :inherit bold :foreground ,fg-main)))
    `(autumn-themes-mark-alt ((,class :inherit bold :background ,bg-mark-alt :foreground ,fg-mark-alt)))
    `(autumn-themes-mark-del ((,class :inherit bold :background ,bg-mark-del :foreground ,fg-mark-del)))
    `(autumn-themes-mark-sel ((,class :inherit bold :background ,bg-mark-sel :foreground ,fg-mark-sel)))
    `(autumn-themes-mark-symbol ((,class :inherit bold :foreground ,blue-alt)))
;;;;; heading levels
    ;; styles for regular headings used in Org, Markdown, Info, etc.
    `(autumn-themes-heading-1
      ((,class ,@(autumn-themes--heading
                  1 fg-main magenta-alt-other
                  magenta-nuanced-bg bg-alt bg-region)
               ,@(autumn-themes--scale autumn-themes-scale-4))))
    `(autumn-themes-heading-2
      ((,class ,@(autumn-themes--heading
                  2 fg-special-warm magenta-alt
                  red-nuanced-bg bg-alt bg-region)
               ,@(autumn-themes--scale autumn-themes-scale-3))))
    `(autumn-themes-heading-3
      ((,class ,@(autumn-themes--heading
                  3 fg-special-cold blue
                  blue-nuanced-bg bg-alt bg-region)
               ,@(autumn-themes--scale autumn-themes-scale-2))))
    `(autumn-themes-heading-4
      ((,class ,@(autumn-themes--heading
                  4 fg-special-mild cyan
                  cyan-nuanced-bg bg-alt bg-region)
               ,@(autumn-themes--scale autumn-themes-scale-1))))
    `(autumn-themes-heading-5
      ((,class ,@(autumn-themes--heading
                  5 fg-special-calm green-alt-other
                  green-nuanced-bg bg-alt bg-region))))
    `(autumn-themes-heading-6
      ((,class ,@(autumn-themes--heading
                  6 yellow-nuanced-fg yellow-alt-other
                  yellow-nuanced-bg bg-alt bg-region))))
    `(autumn-themes-heading-7
      ((,class ,@(autumn-themes--heading
                  7 red-nuanced-fg red-alt
                  red-nuanced-bg bg-alt bg-region))))
    `(autumn-themes-heading-8
      ((,class ,@(autumn-themes--heading
                  8 magenta-nuanced-fg magenta
                  bg-alt bg-alt bg-region))))
;;;;; graph-specific faces
    `(autumn-themes-graph-red-0 ((,class :background ,red-graph-0-bg)))
    `(autumn-themes-graph-red-1 ((,class :background ,red-graph-1-bg)))
    `(autumn-themes-graph-green-0 ((,class :background ,green-graph-0-bg)))
    `(autumn-themes-graph-green-1 ((,class :background ,green-graph-1-bg)))
    `(autumn-themes-graph-yellow-0 ((,class :background ,yellow-graph-0-bg)))
    `(autumn-themes-graph-yellow-1 ((,class :background ,yellow-graph-1-bg)))
    `(autumn-themes-graph-blue-0 ((,class :background ,blue-graph-0-bg)))
    `(autumn-themes-graph-blue-1 ((,class :background ,blue-graph-1-bg)))
    `(autumn-themes-graph-magenta-0 ((,class :background ,magenta-graph-0-bg)))
    `(autumn-themes-graph-magenta-1 ((,class :background ,magenta-graph-1-bg)))
    `(autumn-themes-graph-cyan-0 ((,class :background ,cyan-graph-0-bg)))
    `(autumn-themes-graph-cyan-1 ((,class :background ,cyan-graph-1-bg)))
;;;;; language checkers
    `(autumn-themes-lang-error ((,class ,@(autumn-themes--lang-check
                                          fg-lang-underline-error fg-lang-error
                                          red red-refine-fg red-nuanced-bg red-refine-bg))))
    `(autumn-themes-lang-note ((,class ,@(autumn-themes--lang-check
                                         fg-lang-underline-note fg-lang-note
                                         blue-alt blue-refine-fg blue-nuanced-bg blue-refine-bg))))
    `(autumn-themes-lang-warning ((,class ,@(autumn-themes--lang-check
                                            fg-lang-underline-warning fg-lang-warning
                                            yellow yellow-refine-fg yellow-nuanced-bg yellow-refine-bg))))
;;;;; other custom faces
    `(autumn-themes-bold ((,class ,@(autumn-themes--bold-weight))))
    `(autumn-themes-hl-line ((,class ,@(autumn-themes--hl-line
                                       bg-hl-line bg-hl-line-intense
                                       bg-hl-line-intense-accent blue-nuanced-bg
                                       bg-region blue-intense-bg
                                       fg-alt cyan-intense)
                                    :extend t)))
    `(autumn-themes-key-binding ((,class ,@(if (facep 'help-key-binding) ; check emacs28 face
                                              (list :inherit 'help-key-binding)
                                            (list :inherit 'bold :foreground blue-alt-other)))))
    `(autumn-themes-prompt ((,class ,@(autumn-themes--prompt
                                      cyan-alt-other blue-alt-other fg-alt
                                      cyan-nuanced-bg blue-refine-bg fg-main
                                      bg-alt bg-active))))
    `(autumn-themes-reset-hard ((,class :inherit (fixed-pitch autumn-themes-reset-soft))))
    `(autumn-themes-reset-soft ((,class :background ,bg-main :foreground ,fg-main
                                       :weight normal :slant normal :strike-through nil
                                       :box nil :underline nil :overline nil :extend nil)))
    `(autumn-themes-search-success ((,class :inherit ,@(autumn-themes--success-deuteran
                                                       'autumn-themes-intense-blue
                                                       'autumn-themes-intense-green))))
    `(autumn-themes-search-success-lazy ((,class :inherit ,@(autumn-themes--success-deuteran
                                                            'autumn-themes-special-mild
                                                            'autumn-themes-refine-cyan))))
    `(autumn-themes-search-success-modeline ((,class :foreground ,@(autumn-themes--success-deuteran
                                                                   blue-active
                                                                   green-active))))
    `(autumn-themes-slant ((,class :inherit italic :slant ,@(autumn-themes--slant))))
    `(autumn-themes-variable-pitch ((,class ,@(autumn-themes--variable-pitch))))
    `(autumn-themes-fixed-pitch ((,class ,@(autumn-themes--fixed-pitch))))
;;;; standard faces
;;;;; absolute essentials
    `(default ((,class :background ,bg-main :foreground ,fg-main)))
    `(cursor ((,class :background ,cursor-color)))
    `(fringe ((,class ,@(autumn-themes--fringe bg-main bg-inactive bg-active)
                      :foreground ,fg-main)))
...
;;;;; basic and/or ungrouped styles
    ...
    `(comint-highlight-prompt ((,class :inherit autumn-themes-prompt)))
    `(error ((,class :inherit bold :foreground ,red)))
    `(escape-glyph ((,class :foreground ,fg-escape-char-construct)))
    `(file-name-shadow ((,class :foreground ,fg-unfocused)))
    `(header-line ((,class ,@(autumn-themes--variable-pitch-ui)
                           :background ,bg-header :foreground ,fg-header)))
    `(header-line-highlight ((,class :inherit autumn-themes-active-blue)))
    `(help-argument-name ((,class :inherit autumn-themes-slant :foreground ,cyan)))
    ...
    `(minibuffer-prompt ((,class :inherit autumn-themes-prompt)))
    `(mm-command-output ((,class :foreground ,red-alt-other)))
    `(mm-uu-extract ((,class :background ,bg-dim :foreground ,fg-special-mild)))
    `(next-error ((,class :inherit autumn-themes-subtle-red :extend t)))
    `(rectangle-preview ((,class :inherit autumn-themes-special-mild)))
    `(region ((,class ,@(autumn-themes--region bg-region fg-main
                                              bg-hl-alt-intense bg-region-accent
                                              bg-region-accent-subtle))))
    `(secondary-selection ((,class :inherit autumn-themes-special-cold)))
    `(shadow ((,class :foreground ,fg-alt)))
    `(success ((,class :inherit bold :foreground ,@(autumn-themes--success-deuteran blue green))))
    `(trailing-whitespace ((,class :background ,red-intense-bg)))
    `(warning ((,class :inherit bold :foreground ,yellow)))
;;;;; buttons, links, widgets
    `(button ((,class ,@(autumn-themes--link
...
;;;;; ag
    ...
    `(ag-match-face ((,class :inherit autumn-themes-special-calm)))
;;;;; alert
...
;;;;; annotate
    `(annotate-annotation ((,class :inherit autumn-themes-subtle-blue)))
    `(annotate-annotation-secondary ((,class :inherit autumn-themes-subtle-green)))
...
;;;;; anzu
    `(anzu-match-1 ((,class :inherit autumn-themes-subtle-cyan)))
    `(anzu-match-2 ((,class :inherit autumn-themes-search-success)))
    `(anzu-match-3 ((,class :inherit autumn-themes-subtle-yellow)))
    `(anzu-mode-line ((,class :inherit (bold autumn-themes-search-success-modeline))))
    `(anzu-mode-line-no-match ((,class :inherit bold :foreground ,red-active)))
    `(anzu-replace-highlight ((,class :inherit autumn-themes-refine-yellow :underline t)))
    `(anzu-replace-to ((,class :inherit (autumn-themes-search-success bold))))
;;;;; apropos
    ...
    `(apropos-keybinding ((,class :inherit autumn-themes-key-binding)))
    `(apropos-misc-button ((,class :inherit button
                                   ,@(autumn-themes--link-color
                                      green-alt-other green-alt-other-faint))))
    `(apropos-property ((,class :inherit autumn-themes-bold :foreground ,magenta-alt)))
    `(apropos-symbol ((,class :inherit autumn-themes-pseudo-header)))
...
;;;;; artbollocks-mode
    `(artbollocks-face ((,class :inherit autumn-themes-lang-note)))
    `(artbollocks-lexical-illusions-face ((,class :background ,bg-alt :foreground ,red-alt :underline t)))
    `(artbollocks-passive-voice-face ((,class :inherit autumn-themes-lang-warning)))
    `(artbollocks-weasel-words-face ((,class :inherit autumn-themes-lang-error)))
;;;;; auctex and Tex
    `(font-latex-bold-face ((,class :inherit bold :foreground ,fg-special-calm)))
    `(font-latex-doctex-documentation-face ((,class :inherit autumn-themes-slant :foreground ,fg-special-cold)))
    `(font-latex-doctex-preprocessor-face ((,class :inherit autumn-themes-bold :foreground ,red-alt-other)))
    `(font-latex-italic-face ((,class :inherit italic)))
    `(font-latex-math-face ((,class :foreground ,cyan-alt-other)))
    `(font-latex-script-char-face ((,class :foreground ,cyan-alt-other)))
    `(font-latex-sectioning-0-face ((,class :inherit autumn-themes-variable-pitch :foreground ,blue-nuanced-fg)))
    `(font-latex-sectioning-1-face ((,class :inherit (bold autumn-themes-variable-pitch) :foreground ,blue-nuanced-fg)))
    `(font-latex-sectioning-2-face ((,class :inherit (bold autumn-themes-variable-pitch) :foreground ,blue-nuanced-fg)))
    `(font-latex-sectioning-3-face ((,class :inherit (bold autumn-themes-variable-pitch) :foreground ,blue-nuanced-fg)))
    `(font-latex-sectioning-4-face ((,class :inherit (bold autumn-themes-variable-pitch) :foreground ,blue-nuanced-fg)))
    `(font-latex-sectioning-5-face ((,class :inherit autumn-themes-variable-pitch :foreground ,blue-nuanced-fg)))
    `(font-latex-sedate-face ((,class :inherit autumn-themes-bold :foreground ,magenta-alt-other)))
    `(font-latex-slide-title-face ((,class :inherit (bold autumn-themes-variable-pitch) :foreground ,cyan-nuanced-fg
                                           ,@(autumn-themes--scale autumn-themes-scale-4))))
...
;;;;; avy
    ...
    `(avy-goto-char-timer-face ((,class :inherit (autumn-themes-intense-yellow bold))))
    `(avy-lead-face ((,class :inherit (autumn-themes-intense-magenta bold autumn-themes-reset-soft))))
    `(avy-lead-face-0 ((,class :inherit (autumn-themes-refine-cyan bold autumn-themes-reset-soft))))
    `(avy-lead-face-1 ((,class :inherit (autumn-themes-intense-neutral bold autumn-themes-reset-soft))))
    `(avy-lead-face-2 ((,class :inherit (autumn-themes-refine-red bold autumn-themes-reset-soft))))
;;;;; aw (ace-window)
    `(aw-background-face ((,class :foreground ,fg-unfocused)))
    `(aw-key-face ((,class :inherit autumn-themes-key-binding)))
    `(aw-leading-char-face ((,class :inherit (bold autumn-themes-reset-soft) :height 1.5
                                    :foreground ,red-intense)))
    `(aw-minibuffer-leading-char-face ((,class :inherit (autumn-themes-intense-red bold))))
...
;;;;; binder
    `(binder-sidebar-highlight ((,class :inherit autumn-themes-subtle-cyan)))
    `(binder-sidebar-marked ((,class :inherit autumn-themes-mark-sel)))
    `(binder-sidebar-missing ((,class :inherit autumn-themes-subtle-red)))
    `(binder-sidebar-tags ((,class :foreground ,cyan)))
;;;;; bm
    `(bm-face ((,class :inherit autumn-themes-subtle-yellow :extend t)))
    `(bm-fringe-face ((,class :inherit autumn-themes-fringe-yellow)))
    `(bm-fringe-persistent-face ((,class :inherit autumn-themes-fringe-blue)))
    `(bm-persistent-face ((,class :inherit autumn-themes-intense-blue :extend t)))
;;;;; bongo
    ...
    `(bongo-elapsed-track-part ((,class :inherit autumn-themes-subtle-magenta :underline t)))
...
;;;;; boon
    `(boon-modeline-cmd ((,class :inherit autumn-themes-active-blue)))
    `(boon-modeline-ins ((,class :inherit autumn-themes-active-red)))
    `(boon-modeline-off ((,class :inherit autumn-themes-active-yellow)))
    `(boon-modeline-spc ((,class :inherit autumn-themes-active-green)))
;;;;; bookmark
    `(bookmark-face ((,class :inherit autumn-themes-fringe-cyan)))
...
;;;;; buffer-expose
    ...
    `(buffer-expose-selected-face ((,class :inherit autumn-themes-special-mild)))
;;;;; calendar and diary
    `(calendar-month-header ((,class :inherit autumn-themes-pseudo-header)))
...
;;;;; calfw
    ...
    `(cfw:face-select ((,class :inherit autumn-themes-intense-blue)))
    `(cfw:face-sunday ((,class :inherit bold :foreground ,cyan-alt-other)))
    `(cfw:face-title ((,class :inherit autumn-themes-variable-pitch
                              :foreground ,fg-special-cold
                              ,@(autumn-themes--scale autumn-themes-scale-title))))
...
;;;;; centaur-tabs
    ...
    `(centaur-tabs-selected ((,class ,@(autumn-themes--tab bg-tab-active nil nil nil t t))))
    `(centaur-tabs-selected-modified ((,class :inherit (italic centaur-tabs-selected))))
    `(centaur-tabs-unselected ((,class ,@(autumn-themes--tab bg-tab-inactive bg-tab-inactive-accent fg-dim nil t))))
...
;;;;; cider
    ...
    `(cider-deprecated-face ((,class :inherit autumn-themes-refine-yellow)))
    ...
    `(cider-repl-prompt-face ((,class :inherit autumn-themes-prompt)))
    ...
    `(cider-test-error-face ((,class :inherit autumn-themes-subtle-red)))
    `(cider-test-failure-face ((,class :inherit (autumn-themes-intense-red bold))))
    `(cider-test-success-face ((,class :inherit ,@(autumn-themes--success-deuteran
                                                   'autumn-themes-intense-blue
                                                   'autumn-themes-intense-green))))
...
;;;;; circe (and lui)
    ...
    `(circe-prompt-face ((,class :inherit autumn-themes-prompt)))
...
;;;;; color-rg
    ...
    `(color-rg-font-lock-flash ((,class :inherit autumn-themes-intense-blue)))
    `(color-rg-font-lock-function-location ((,class :inherit autumn-themes-special-calm)))
    ...
    `(color-rg-font-lock-match ((,class :inherit autumn-themes-special-calm)))
    `(color-rg-font-lock-position-splitter ((,class :inherit shadow)))
;;;;; column-enforce-mode
    `(column-enforce-face ((,class :inherit autumn-themes-refine-yellow)))
;;;;; company-mode
    ...
    `(company-preview-search ((,class :inherit autumn-themes-special-calm)))
    `(company-scrollbar-bg ((,class :background ,bg-active)))
    `(company-scrollbar-fg ((,class :background ,fg-active)))
    `(company-template-field ((,class :inherit autumn-themes-intense-magenta)))
    `(company-tooltip ((,class :background ,bg-alt :foreground ,fg-alt)))
    `(company-tooltip-annotation ((,class :inherit autumn-themes-slant :foreground ,fg-special-cold)))
    ...
    `(company-tooltip-mouse ((,class :inherit autumn-themes-intense-blue)))
    `(company-tooltip-search ((,class :inherit (autumn-themes-search-success-lazy bold))))
    `(company-tooltip-search-selection ((,class :inherit (autumn-themes-search-success bold) :underline t)))
    `(company-tooltip-selection ((,class :inherit (autumn-themes-subtle-cyan bold))))
;;;;; company-posframe
...
;;;;; compilation feedback
    ...
    `(compilation-error ((,class :inherit autumn-themes-bold :foreground ,red)))
    `(compilation-info ((,class :inherit autumn-themes-bold :foreground ,fg-special-cold)))
    `(compilation-line-number ((,class :foreground ,fg-special-warm)))
    `(compilation-mode-line-exit ((,class :inherit autumn-themes-bold :foreground ,blue-active)))
    `(compilation-mode-line-fail ((,class :inherit autumn-themes-bold :foreground ,red-active)))
    `(compilation-mode-line-run ((,class :inherit autumn-themes-bold :foreground ,magenta-active)))
    `(compilation-warning ((,class :inherit autumn-themes-bold :foreground ,yellow)))
;;;;; completions
    `(completions-annotations ((,class :inherit autumn-themes-slant :foreground ,cyan-faint)))
    `(completions-common-part ((,class ,@(autumn-themes--standard-completions
                                          blue-alt blue-nuanced-bg
                                          cyan-refine-bg cyan-refine-fg))))
    `(completions-first-difference ((,class :inherit bold
                                            ,@(autumn-themes--standard-completions
...
;;;;; consult
    ...
    `(consult-key ((,class :inherit autumn-themes-key-binding)))
    ...
    `(consult-preview-cursor ((,class :inherit autumn-themes-intense-blue)))
    `(consult-preview-error ((,class :inherit autumn-themes-intense-red)))
...
;;;;; counsel
    ...
    `(counsel-key-binding ((,class :inherit autumn-themes-key-binding)))
    ...
    `(counsel-variable-documentation ((,class :inherit autumn-themes-slant :foreground ,yellow-alt-other)))
;;;;; counsel-css
...
;;;;; ctrlf
    `(ctrlf-highlight-active ((,class :inherit (autumn-themes-search-success bold))))
    `(ctrlf-highlight-line ((,class :inherit autumn-themes-hl-line)))
    `(ctrlf-highlight-passive ((,class :inherit autumn-themes-search-success-lazy)))
;;;;; cursor-flash
    `(cursor-flash-face ((,class :inherit autumn-themes-intense-blue)))
;;;;; custom (M-x customize)
    ...
    `(custom-button-pressed ((,class :box (:line-width 2 :color nil :style pressed-button)
                                     :background ,bg-active :foreground ,fg-main)))
    `(custom-changed ((,class :inherit autumn-themes-subtle-cyan)))
    ...
    `(custom-group-tag-1 ((,class :inherit autumn-themes-special-warm)))
    `(custom-invalid ((,class :inherit (autumn-themes-intense-red bold))))
    `(custom-modified ((,class :inherit autumn-themes-subtle-cyan)))
    `(custom-rogue ((,class :inherit autumn-themes-refine-magenta)))
    `(custom-set ((,class :foreground ,blue-alt)))
    `(custom-state ((,class :foreground ,cyan-alt-other)))
    `(custom-themed ((,class :inherit autumn-themes-subtle-blue)))
...
;;;;; dap-mode
    ...
    `(dap-ui-marker-face ((,class :inherit autumn-themes-subtle-blue)))
...
;;;;; deadgrep
    ...
    `(deadgrep-match-face ((,class :inherit autumn-themes-special-calm)))
...
;;;;; deft
    `(deft-filter-string-error-face ((,class :inherit autumn-themes-refine-red)))
    ...
    `(deft-summary-face ((,class :inherit autumn-themes-slant :foreground ,fg-alt)))
...
;;;;; diff-hl
    `(diff-hl-change ((,class :inherit autumn-themes-fringe-yellow)))
    `(diff-hl-delete ((,class :inherit autumn-themes-fringe-red)))
    ...
    `(diff-hl-insert ((,class :inherit ,@(autumn-themes--diff-deuteran
                                          'autumn-themes-fringe-blue
                                          'autumn-themes-fringe-green))))
    `(diff-hl-reverted-hunk-highlight ((,class :background ,fg-main :foreground ,bg-main)))
;;;;; diff-mode
    `(diff-added ((,class :inherit autumn-themes-diff-added)))
    `(diff-changed ((,class :inherit autumn-themes-diff-changed :extend t)))
    `(diff-context ((,class ,@(unless (eq autumn-themes-diffs 'bg-only) (list :foreground fg-unfocused)))))
    `(diff-error ((,class :inherit autumn-themes-intense-red)))
    `(diff-file-header ((,class :inherit (bold diff-header))))
    `(diff-function ((,class :inherit autumn-themes-diff-heading)))
    `(diff-header ((,class :foreground ,fg-main)))
    `(diff-hunk-header ((,class :inherit (bold autumn-themes-diff-heading))))
    `(diff-index ((,class :inherit bold :foreground ,blue-alt)))
    `(diff-indicator-added ((,class :inherit (diff-added bold)
                                    :foreground ,@(autumn-themes--diff-deuteran blue green))))
    ...
    `(diff-nonexistent ((,class :inherit (autumn-themes-neutral bold))))
    `(diff-refine-added ((,class :inherit autumn-themes-diff-refine-added)))
    `(diff-refine-changed ((,class :inherit autumn-themes-diff-refine-changed)))
    `(diff-refine-removed ((,class :inherit autumn-themes-diff-refine-removed)))
    `(diff-removed ((,class :inherit autumn-themes-diff-removed)))
;;;;; dim-autoload
...
;;;;; dir-treeview
    ...
    `(dir-treeview-start-dir-face ((,class :inherit autumn-themes-pseudo-header)))
...
;;;;; dired
    ...
    `(dired-flagged ((,class :inherit autumn-themes-mark-del)))
    `(dired-header ((,class :inherit autumn-themes-pseudo-header)))
    `(dired-ignored ((,class :inherit shadow)))
    `(dired-mark ((,class :inherit autumn-themes-mark-symbol)))
    `(dired-marked ((,class :inherit autumn-themes-mark-sel)))
...
;;;;; dired-narrow
    `(dired-narrow-blink ((,class :inherit (autumn-themes-subtle-cyan bold))))
;;;;; dired-subtree
...
;;;;; diredfl
    `(diredfl-autofile-name ((,class :inherit autumn-themes-special-cold)))
    ...
    `(diredfl-deletion ((,class :inherit autumn-themes-mark-del)))
    `(diredfl-deletion-file-name ((,class :inherit autumn-themes-mark-del)))
    `(diredfl-dir-heading ((,class :inherit autumn-themes-pseudo-header)))
    ...
    `(diredfl-flag-mark ((,class :inherit autumn-themes-mark-sel)))
    `(diredfl-flag-mark-line ((,class :inherit autumn-themes-mark-sel)))
    ...
    `(diredfl-tagged-autofile-name ((,class :inherit autumn-themes-refine-magenta)))
    `(diredfl-write-priv ((,class :foreground ,cyan)))
;;;;; dired+
    `(diredp-autofile-name ((,class :inherit autumn-themes-special-cold)))
    ...
    `(diredp-deletion ((,class :inherit autumn-themes-mark-del)))
    `(diredp-deletion-file-name ((,class :inherit autumn-themes-mark-del)))
    `(diredp-dir-heading ((,class :inherit autumn-themes-pseudo-header)))
    ...
    `(diredp-flag-mark ((,class :inherit autumn-themes-mark-sel)))
    `(diredp-flag-mark-line ((,class :inherit autumn-themes-mark-sel)))
    ...
    `(diredp-tagged-autofile-name ((,class :inherit autumn-themes-refine-magenta)))
...
;;;;; doom-modeline
    `(doom-modeline-bar ((,class :inherit autumn-themes-active-blue)))
    ...
    `(doom-modeline-lsp-success ((,class :inherit bold :foreground ,@(autumn-themes--success-deuteran
                                                                      blue-active
                                                                      green-active))))
    `(doom-modeline-lsp-warning ((,class :inherit bold :foreground ,yellow-active)))
    `(doom-modeline-panel ((,class :inherit autumn-themes-active-blue)))
...
;;;;; dynamic-ruler
    `(dynamic-ruler-negative-face ((,class :inherit autumn-themes-intense-neutral)))
    `(dynamic-ruler-positive-face ((,class :inherit autumn-themes-intense-yellow)))
;;;;; easy-jekyll
    `(easy-jekyll-help-face ((,class :background ,bg-dim :foreground ,cyan-alt-other)))
;;;;; easy-kill
    `(easy-kill-origin ((,class :inherit autumn-themes-subtle-red)))
    `(easy-kill-selection ((,class :inherit autumn-themes-subtle-yellow)))
;;;;; ebdb
...
;;;;; ediff
    `(ediff-current-diff-A ((,class :inherit autumn-themes-diff-removed)))
    `(ediff-current-diff-Ancestor ((,class ,@(autumn-themes--diff
                                              bg-alt fg-special-cold
                                              bg-special-cold fg-special-cold
                                              blue-nuanced-bg blue))))
    `(ediff-current-diff-B ((,class :inherit autumn-themes-diff-added)))
    `(ediff-current-diff-C ((,class :inherit autumn-themes-diff-changed)))
    ...
    `(ediff-fine-diff-A ((,class :inherit autumn-themes-diff-refine-removed)))
    `(ediff-fine-diff-Ancestor ((,class :inherit autumn-themes-refine-cyan)))
    `(ediff-fine-diff-B ((,class :inherit autumn-themes-diff-refine-added)))
    `(ediff-fine-diff-C ((,class :inherit autumn-themes-diff-refine-changed)))
...
;;;;; eglot
    `(eglot-mode-line ((,class :inherit autumn-themes-bold :foreground ,magenta-active)))
;;;;; el-search
    `(el-search-highlight-in-prompt-face ((,class :inherit bold :foreground ,magenta-alt)))
    `(el-search-match ((,class :inherit autumn-themes-search-success)))
    `(el-search-other-match ((,class :inherit autumn-themes-special-mild)))
    `(el-search-occur-match ((,class :inherit autumn-themes-special-calm)))
;;;;; eldoc
...
;;;;; elpher
    `(elpher-gemini-heading1 ((,class :inherit autumn-themes-heading-1)))
    `(elpher-gemini-heading2 ((,class :inherit autumn-themes-heading-2)))
    `(elpher-gemini-heading3 ((,class :inherit autumn-themes-heading-3)))
;;;;; embark
    `(embark-keybinding ((,class :inherit autumn-themes-key-binding)))
;;;;; emms
    `(emms-browser-album-face ((,class :foreground ,magenta-alt-other ,@(autumn-themes--scale autumn-themes-scale-2))))
    `(emms-browser-artist-face ((,class :foreground ,cyan ,@(autumn-themes--scale autumn-themes-scale-3))))
    `(emms-browser-composer-face ((,class :foreground ,magenta-alt ,@(autumn-themes--scale autumn-themes-scale-3))))
    ...
    `(emms-browser-year/genre-face ((,class :foreground ,cyan-alt-other ,@(autumn-themes--scale autumn-themes-scale-4))))
...
;;;;; enh-ruby-mode (enhanced-ruby-mode)
    ...
    `(erm-syn-errline ((,class :inherit autumn-themes-lang-error)))
    `(erm-syn-warnline ((,class :inherit autumn-themes-lang-warning)))
;;;;; epa
...
;;;;; erc
    ...
    `(erc-dangerous-host-face ((,class :inherit autumn-themes-intense-red)))
    ...
    `(erc-prompt-face ((,class :inherit autumn-themes-prompt)))
...
;;;;; ert
    `(ert-test-result-expected ((,class :inherit autumn-themes-intense-green)))
    `(ert-test-result-unexpected ((,class :inherit autumn-themes-intense-red)))
;;;;; eshell
    ...
    `(eshell-ls-missing ((,class :inherit autumn-themes-intense-red)))
    ...
    `(eshell-prompt ((,class :inherit autumn-themes-prompt)))
;;;;; eshell-fringe-status
...
;;;;; eshell-prompt-extras (epe)
    ...
    `(epe-remote-face ((,class :inherit (shadow autumn-themes-slant))))
    `(epe-status-face ((,class :foreground ,magenta-alt-other)))
    `(epe-venv-face ((,class :inherit (shadow autumn-themes-slant))))
;;;;; eshell-syntax-highlighting
...
;;;;; evil-mode
    ...
    `(evil-ex-lazy-highlight ((,class :inherit autumn-themes-search-success-lazy)))
    `(evil-ex-search ((,class :inherit autumn-themes-search-success)))
    `(evil-ex-substitute-matches ((,class :inherit autumn-themes-refine-yellow :underline t)))
    `(evil-ex-substitute-replacement ((,class :inherit (autumn-themes-search-success bold))))
;;;;; evil-goggles
    `(evil-goggles-change-face ((,class :inherit autumn-themes-refine-yellow)))
    `(evil-goggles-commentary-face ((,class :inherit (autumn-themes-subtle-neutral autumn-themes-slant))))
    `(evil-goggles-default-face ((,class :inherit autumn-themes-subtle-neutral)))
    `(evil-goggles-delete-face ((,class :inherit autumn-themes-refine-red)))
    ...
    `(evil-goggles-join-face ((,class :inherit autumn-themes-subtle-green)))
    `(evil-goggles-nerd-commenter-face ((,class :inherit evil-goggles-commentary-face)))
    `(evil-goggles-paste-face ((,class :inherit autumn-themes-subtle-cyan)))
    `(evil-goggles-record-macro-face ((,class :inherit autumn-themes-special-cold)))
    `(evil-goggles-replace-with-register-face ((,class :inherit autumn-themes-refine-magenta)))
    `(evil-goggles-set-marker-face ((,class :inherit autumn-themes-intense-magenta)))
    ...
    `(evil-goggles-yank-face ((,class :inherit autumn-themes-subtle-blue)))
;;;;; evil-snipe
    `(evil-snipe-first-match-face ((,class :inherit (bold autumn-themes-intense-blue))))
    `(evil-snipe-matches-face ((,class :inherit autumn-themes-refine-magenta)))
;;;;; evil-visual-mark-mode
    `(evil-visual-mark-face ((,class :inherit autumn-themes-intense-magenta)))
;;;;; eww
...
;;;;; fancy-dabbrev
    ...
    `(fancy-dabbrev-selection-face ((,class :inherit (autumn-themes-intense-cyan bold))))
;;;;; flycheck
    `(flycheck-error ((,class :inherit autumn-themes-lang-error)))
    ...
    `(flycheck-error-list-error ((,class :inherit autumn-themes-bold :foreground ,red)))
    `(flycheck-error-list-filename ((,class :foreground ,blue)))
    `(flycheck-error-list-highlight ((,class :inherit autumn-themes-hl-line)))
    ...
    `(flycheck-fringe-error ((,class :inherit autumn-themes-fringe-red)))
    `(flycheck-fringe-info ((,class :inherit autumn-themes-fringe-cyan)))
    `(flycheck-fringe-warning ((,class :inherit autumn-themes-fringe-yellow)))
    `(flycheck-info ((,class :inherit autumn-themes-lang-note)))
    `(flycheck-verify-select-checker ((,class :box (:line-width 1 :color nil :style released-button))))
    `(flycheck-warning ((,class :inherit autumn-themes-lang-warning)))
;;;;; flycheck-color-mode-line
...
;;;;; flycheck-indicator
    `(flycheck-indicator-disabled ((,class :inherit autumn-themes-slant :foreground ,fg-inactive)))
    `(flycheck-indicator-error ((,class :inherit autumn-themes-bold :foreground ,red-active)))
    `(flycheck-indicator-info ((,class :inherit autumn-themes-bold :foreground ,blue-active)))
    `(flycheck-indicator-running ((,class :inherit autumn-themes-bold :foreground ,magenta-active)))
    `(flycheck-indicator-success ((,class :inherit autumn-themes-bold
                                          :foreground ,@(autumn-themes--success-deuteran
                                                         blue-active
                                                         green-active))))
    `(flycheck-indicator-warning ((,class :inherit autumn-themes-bold :foreground ,yellow-active)))
;;;;; flycheck-posframe
    ...
    `(flycheck-posframe-face ((,class :inherit autumn-themes-slant :foreground ,fg-main)))
...
;;;;; flymake
    `(flymake-error ((,class :inherit autumn-themes-lang-error)))
    `(flymake-note ((,class :inherit autumn-themes-lang-note)))
    `(flymake-warning ((,class :inherit autumn-themes-lang-warning)))
;;;;; flyspell
    `(flyspell-duplicate ((,class :inherit autumn-themes-lang-warning)))
    `(flyspell-incorrect ((,class :inherit autumn-themes-lang-error)))
;;;;; flyspell-correct
    `(flyspell-correct-highlight-face ((,class :inherit autumn-themes-refine-green)))
;;;;; flx
    `(flx-highlight-face ((,class ,@(autumn-themes--extra-completions
                                     'autumn-themes-subtle-magenta
                                     'autumn-themes-intense-magenta
                                     'autumn-themes-nuanced-magenta
                                     magenta-alt
                                     'bold))))
;;;;; freeze-it
    `(freeze-it-show ((,class :background ,bg-dim :foreground ,fg-special-warm)))
;;;;; frog-menu
    `(frog-menu-action-keybinding-face ((,class :inherit autumn-themes-key-binding)))
...
;;;;; fold-this
    `(fold-this-overlay ((,class :inherit autumn-themes-special-mild)))
;;;;; font-lock
    `(font-lock-builtin-face ((,class :inherit autumn-themes-bold
                                      ,@(autumn-themes--syntax-extra
                                         magenta-alt magenta-alt-faint
                                         magenta magenta-faint))))
    `(font-lock-comment-delimiter-face ((,class :inherit font-lock-comment-face)))
    `(font-lock-comment-face ((,class :inherit autumn-themes-slant
                                      ,@(autumn-themes--syntax-comment
                                         fg-alt fg-comment-yellow yellow-alt-other-faint))))
    `(font-lock-constant-face ((,class ,@(autumn-themes--syntax-extra
                                          blue-alt-other blue-alt-other-faint
                                          magenta-alt-other magenta-alt-other-faint))))
    `(font-lock-doc-face ((,class :inherit autumn-themes-slant
                                  ,@(autumn-themes--syntax-string
                                     fg-docstring fg-special-cold
                                     fg-special-mild magenta-nuanced-fg
                                     fg-special-mild magenta-nuanced-fg))))
    `(font-lock-function-name-face ((,class ,@(autumn-themes--syntax-extra
                                               magenta magenta-faint
                                               magenta-alt magenta-alt-faint))))
    `(font-lock-keyword-face ((,class :inherit autumn-themes-bold
                                      ,@(autumn-themes--syntax-extra
                                         magenta-alt-other magenta-alt-other-faint
                                         cyan cyan-faint))))
    `(font-lock-negation-char-face ((,class :inherit autumn-themes-bold
                                            ,@(autumn-themes--syntax-foreground
                                               yellow yellow-faint))))
    `(font-lock-preprocessor-face ((,class ,@(autumn-themes--syntax-extra
    ...
    `(font-lock-string-face ((,class ,@(autumn-themes--syntax-string
                                        blue-alt blue-alt-faint
                                        green red
                                        green-faint red-faint))))
    `(font-lock-type-face ((,class :inherit autumn-themes-bold
                                   ,@(autumn-themes--syntax-foreground
                                      cyan-alt-other cyan-alt-faint))))
    `(font-lock-variable-name-face ((,class ,@(autumn-themes--syntax-extra
                                               cyan cyan-faint
                                               blue-alt-other blue-alt-other-faint))))
    `(font-lock-warning-face ((,class :inherit autumn-themes-bold
                                      ,@(autumn-themes--syntax-comment
...
;;;;; forge
    ...
    `(forge-topic-unmerged ((,class :inherit autumn-themes-slant :foreground ,magenta)))
    `(forge-topic-unread ((,class :inherit bold :foreground ,fg-main)))
;;;;; fountain-mode
    `(fountain-character ((,class :foreground ,blue-alt-other)))
    `(fountain-comment ((,class :inherit autumn-themes-slant :foreground ,fg-alt)))
    ...
    `(fountain-note ((,class :inherit autumn-themes-slant :foreground ,yellow)))
    ...
    `(fountain-section-heading ((,class :inherit autumn-themes-heading-1)))
    `(fountain-section-heading-1 ((,class :inherit autumn-themes-heading-1)))
    `(fountain-section-heading-2 ((,class :inherit autumn-themes-heading-2)))
    `(fountain-section-heading-3 ((,class :inherit autumn-themes-heading-3)))
    `(fountain-section-heading-4 ((,class :inherit autumn-themes-heading-4)))
    `(fountain-section-heading-5 ((,class :inherit autumn-themes-heading-5)))
...
;;;;; geiser
    ...
    `(geiser-font-lock-repl-prompt ((,class :inherit autumn-themes-prompt)))
...
;;;;; git-commit
    ...
    `(git-commit-comment-branch-local ((,class :inherit autumn-themes-slant :foreground ,blue-alt)))
    `(git-commit-comment-branch-remote ((,class :inherit autumn-themes-slant :foreground ,magenta-alt)))
    `(git-commit-comment-detached ((,class :inherit autumn-themes-slant :foreground ,cyan-alt)))
    `(git-commit-comment-file ((,class :inherit autumn-themes-slant
                                       ,@(autumn-themes--syntax-comment
                                          fg-special-cold red-nuanced-fg))))
    `(git-commit-comment-heading ((,class :inherit (bold autumn-themes-slant)
                                          ,@(autumn-themes--syntax-comment
                                             fg-dim fg-special-warm))))
    `(git-commit-keyword ((,class :foreground ,magenta)))
    `(git-commit-known-pseudo-header ((,class :foreground ,cyan-alt-other)))
    `(git-commit-nonempty-second-line ((,class :inherit autumn-themes-refine-yellow)))
    `(git-commit-overlong-summary ((,class :inherit autumn-themes-refine-yellow)))
    `(git-commit-pseudo-header ((,class :foreground ,blue)))
    `(git-commit-summary ((,class :inherit bold :foreground ,cyan)))
;;;;; git-gutter
    `(git-gutter:added ((,class :inherit ,@(autumn-themes--diff-deuteran
                                            'autumn-themes-fringe-blue
                                            'autumn-themes-fringe-green))))
    `(git-gutter:deleted ((,class :inherit autumn-themes-fringe-red)))
    `(git-gutter:modified ((,class :inherit autumn-themes-fringe-yellow)))
    `(git-gutter:separator ((,class :inherit autumn-themes-fringe-cyan)))
    `(git-gutter:unchanged ((,class :inherit autumn-themes-fringe-magenta)))
;;;;; git-gutter-fr
    `(git-gutter-fr:added ((,class :inherit ,@(autumn-themes--diff-deuteran
                                               'autumn-themes-fringe-blue
                                               'autumn-themes-fringe-green))))
    `(git-gutter-fr:deleted ((,class :inherit autumn-themes-fringe-red)))
    `(git-gutter-fr:modified ((,class :inherit autumn-themes-fringe-yellow)))
;;;;; git-{gutter,fringe}+
    `(git-gutter+-added ((,class :inherit ,@(autumn-themes--diff-deuteran
                                          'autumn-themes-fringe-blue
                                          'autumn-themes-fringe-green))))
    ...
    `(git-gutter+-separator ((,class :inherit autumn-themes-fringe-cyan)))
    `(git-gutter+-unchanged ((,class :inherit autumn-themes-fringe-magenta)))
    `(git-gutter-fr+-added ((,class :inherit autumn-themes-fringe-green)))
    `(git-gutter-fr+-deleted ((,class :inherit autumn-themes-fringe-red)))
    `(git-gutter-fr+-modified ((,class :inherit autumn-themes-fringe-yellow)))
;;;;; git-lens
    `(git-lens-added ((,class :inherit bold :foreground ,@(autumn-themes--diff-deuteran blue green))))
...
;;;;; git-rebase
    `(git-rebase-comment-hash ((,class :inherit autumn-themes-slant
                                       ,@(autumn-themes--syntax-comment
                                          fg-special-cold red-nuanced-fg))))
    `(git-rebase-comment-heading  ((,class :inherit (bold autumn-themes-slant)
                                           ,@(autumn-themes--syntax-comment
                                              fg-dim fg-special-warm))))
...
;;;;; gnus
    ...
    `(gnus-emphasis-highlight-words ((,class :inherit autumn-themes-refine-yellow)))
    ...
    `(gnus-server-cloud-host ((,class :inherit autumn-themes-refine-cyan)))
    ...
    `(gnus-summary-cancelled ((,class :inherit autumn-themes-mark-alt :extend t)))
...
;;;;; helm
    `(helm-M-x-key ((,class :inherit autumn-themes-key-binding)))
    ...
    `(helm-ff-denied ((,class ,@(autumn-themes--extra-completions
                                 'autumn-themes-subtle-red
                                 'autumn-themes-intense-red
                                 'autumn-themes-nuanced-red
                                 red))))
    ...
    `(helm-ff-invalid-symlink ((,class :inherit button
                                       ,@(autumn-themes--link-color
                                          red red-faint))))
    `(helm-ff-pipe ((,class ,@(autumn-themes--extra-completions
                               'autumn-themes-refine-magenta
                               'autumn-themes-subtle-magenta
                               'autumn-themes-nuanced-magenta
                               magenta))))
    `(helm-ff-prefix ((,class ,@(autumn-themes--extra-completions
                                 'autumn-themes-refine-yellow
                                 'autumn-themes-subtle-yellow
                                 'autumn-themes-nuanced-yellow
                                 yellow-alt-other))))
    `(helm-ff-socket ((,class :foreground ,red-alt-other)))
    `(helm-ff-suid ((,class ,@(autumn-themes--extra-completions
                               'autumn-themes-subtle-red
                               'autumn-themes-refine-red
                               'autumn-themes-nuanced-yellow
                               red-alt))))
    ...
    `(helm-grep-match ((,class :inherit autumn-themes-special-calm)))
    ...
    `(helm-history-deleted ((,class ,@(autumn-themes--extra-completions
                                       'autumn-themes-subtle-red
                                       'autumn-themes-intense-red
                                       'autumn-themes-nuanced-red
                                       red
    ...
    `(helm-lisp-show-completion ((,class ,@(autumn-themes--extra-completions
                                            'autumn-themes-subtle-yellow
                                            'autumn-themes-refine-yellow
                                            'autumn-themes-nuanced-yellow
                                            yellow
    ...
    `(helm-match ((,class ,@(autumn-themes--extra-completions
                             'autumn-themes-subtle-cyan
                             'autumn-themes-refine-cyan
                             'autumn-themes-nuanced-cyan
                             cyan
                             'bold))))
    `(helm-match-item ((,class ,@(autumn-themes--extra-completions
                                  'autumn-themes-subtle-neutral
                                  'autumn-themes-subtle-cyan
                                  'autumn-themes-nuanced-cyan
                                  cyan-alt-other))))
    `(helm-minibuffer-prompt ((,class :inherit autumn-themes-prompt)))
    `(helm-moccur-buffer ((,class :inherit button
                                  ,@(autumn-themes--link-color
                                     cyan-alt-other cyan-alt-other-faint))))
    `(helm-mode-prefix ((,class ,@(autumn-themes--extra-completions
                                   'autumn-themes-subtle-magenta
                                   'autumn-themes-intense-magenta
                                   'autumn-themes-nuanced-magenta
                                   magenta-alt
    ...
    `(helm-resume-need-update ((,class ,@(autumn-themes--extra-completions
                                          'autumn-themes-subtle-magenta
                                          'autumn-themes-refine-magenta
                                          'autumn-themes-nuanced-magenta
                                          magenta-alt-other))))
    `(helm-selection ((,class ,@(autumn-themes--extra-completions
                                 'autumn-themes-subtle-blue
                                 'autumn-themes-refine-blue
                                 'autumn-themes-special-cold
                                 nil
                                 'bold))))
    `(helm-selection-line ((,class :inherit autumn-themes-special-cold)))
    ...
    `(helm-visible-mark ((,class :inherit autumn-themes-subtle-cyan)))
;;;;; helm-ls-git
...
;;;;; helm-switch-shell
    `(helm-switch-shell-new-shell-face ((,class ,@(autumn-themes--extra-completions
                                                   'autumn-themes-subtle-magenta
                                                   'autumn-themes-refine-magenta
                                                   'autumn-themes-nuanced-magenta
                                                   magenta-alt-other
...
;;;;; helpful
    `(helpful-heading ((,class :inherit autumn-themes-heading-1)))
;;;;; highlight region or ad-hoc regexp
    ...
    `(hl-line ((,class :inherit autumn-themes-hl-line)))
;;;;; highlight-blocks
...
;;;;; highlight-indentation
    `(highlight-indentation-face ((,class :inherit autumn-themes-hl-line)))
    `(highlight-indentation-current-column-face ((,class :background ,bg-active)))
;;;;; highlight-numbers
    `(highlight-numbers-number ((,class :foreground ,blue-alt-other)))
;;;;; highlight-symbol
    `(highlight-symbol-face ((,class :inherit autumn-themes-special-mild)))
;;;;; highlight-thing
...
;;;;; hl-todo
    `(hl-todo ((,class :inherit (bold autumn-themes-slant) :foreground ,red-alt-other)))
;;;;; hydra
...
;;;;; icomplete
    ...
    `(icomplete-selected-match ((,class :inherit bold :foreground ,fg-main
                                        :background ,@(pcase autumn-themes-completions
...
;;;;; ido-mode
    ...
    `(ido-indicator ((,class :inherit autumn-themes-subtle-yellow)))
...
;;;;; iedit
    `(iedit-occurrence ((,class :inherit autumn-themes-refine-blue)))
    `(iedit-read-only-occurrence ((,class :inherit autumn-themes-intense-yellow)))
;;;;; iflipb
...
;;;;; indium
    ...
    `(indium-litable-face ((,class :inherit autumn-themes-slant :foreground ,fg-special-warm)))
    `(indium-repl-error-face ((,class :inherit error)))
    `(indium-repl-prompt-face ((,class :inherit autumn-themes-prompt)))
    `(indium-repl-stdout-face ((,class :foreground ,fg-main)))
;;;;; info
    `(Info-quoted ((,class :inherit autumn-themes-fixed-pitch ; the capitalization is canonical
                           :background ,bg-alt :foreground ,fg-special-calm)))
    `(info-header-node ((,class :inherit bold :foreground ,fg-alt)))
    `(info-header-xref ((,class :foreground ,blue-active)))
    `(info-index-match ((,class :inherit match)))
    `(info-menu-header ((,class :inherit autumn-themes-heading-3)))
    `(info-menu-star ((,class :foreground ,red)))
    `(info-node ((,class :inherit bold)))
    `(info-title-1 ((,class :inherit autumn-themes-heading-1)))
    `(info-title-2 ((,class :inherit autumn-themes-heading-2)))
    `(info-title-3 ((,class :inherit autumn-themes-heading-3)))
    `(info-title-4 ((,class :inherit autumn-themes-heading-4)))
;;;;; info-colors
...
;;;;; ioccur
    ...
    `(ioccur-match-face ((,class :inherit autumn-themes-special-calm)))
    `(ioccur-match-overlay-face ((,class :inherit autumn-themes-special-cold :extend t)))
    `(ioccur-num-line-face ((,class :foreground ,fg-special-warm)))
    `(ioccur-overlay-face ((,class :inherit autumn-themes-refine-blue :extend t)))
    `(ioccur-regexp-face ((,class :inherit (autumn-themes-intense-magenta bold))))
    `(ioccur-title-face ((,class :inherit bold :foreground ,red-alt
                                 ,@(autumn-themes--scale autumn-themes-scale-4))))
;;;;; isearch, occur, and the like
    `(isearch ((,class :inherit (autumn-themes-search-success bold))))
    `(isearch-fail ((,class :inherit autumn-themes-refine-red)))
    `(isearch-group-1 ((,class :inherit autumn-themes-refine-blue)))
    `(isearch-group-2 ((,class :inherit autumn-themes-refine-magenta)))
    `(lazy-highlight ((,class :inherit autumn-themes-search-success-lazy)))
    `(match ((,class :inherit autumn-themes-special-calm)))
    `(query-replace ((,class :inherit (autumn-themes-intense-yellow bold))))
;;;;; isl (isearch-light)
    `(isl-line ((,class :inherit ,@(autumn-themes--success-deuteran
                                    'autumn-themes-subtle-blue
                                    'autumn-themes-subtle-green))))
    `(isl-match ((,class :inherit autumn-themes-search-success-lazy)))
    `(isl-number ((,class :inherit (autumn-themes-bold autumn-themes-search-success-modeline))))
    `(isl-on ((,class :inherit (bold autumn-themes-search-success))))
    `(isl-string ((,class :inherit autumn-themes-bold :foreground ,cyan-active)))
;;;;; ivy
    ...
    `(ivy-current-match ((,class ,@(autumn-themes--extra-completions
                                    'autumn-themes-refine-cyan
                                    'autumn-themes-intense-cyan
                                    'autumn-themes-special-cold
                                    nil
                                    'bold))))
    ...
    `(ivy-minibuffer-match-face-1 ((,class ,@(autumn-themes--extra-completions
                                              'autumn-themes-subtle-neutral
                                              'autumn-themes-intense-neutral
                                              'autumn-themes-nuanced-cyan
                                              fg-alt))))
    `(ivy-minibuffer-match-face-2 ((,class ,@(autumn-themes--extra-completions
                                              'autumn-themes-subtle-green
                                              'autumn-themes-refine-green
                                              'autumn-themes-nuanced-green
                                              green-alt-other
                                              'bold))))
    `(ivy-minibuffer-match-face-3 ((,class ,@(autumn-themes--extra-completions
                                              'autumn-themes-subtle-blue
                                              'autumn-themes-refine-blue
                                              'autumn-themes-nuanced-blue
                                              blue-alt-other
                                              'bold))))
    `(ivy-minibuffer-match-face-4 ((,class ,@(autumn-themes--extra-completions
                                              'autumn-themes-subtle-magenta
                                              'autumn-themes-refine-magenta
                                              'autumn-themes-nuanced-magenta
                                              magenta-alt-other
                                              'bold))))
    `(ivy-minibuffer-match-highlight ((,class ,@(autumn-themes--extra-completions
                                                 'autumn-themes-subtle-cyan
                                                 'autumn-themes-intense-cyan
                                                 'autumn-themes-nuanced-cyan
                                                 cyan-alt-other
                                                 'bold))))
    `(ivy-modified-buffer ((,class :inherit autumn-themes-slant :foreground ,yellow)))
    `(ivy-modified-outside-buffer ((,class :inherit autumn-themes-slant :foreground ,yellow-alt)))
    ...
    `(ivy-yanked-word ((,class ,@(autumn-themes--extra-completions
                                  'autumn-themes-subtle-blue
                                  'autumn-themes-refine-blue
                                  'autumn-themes-nuanced-blue
                                  blue-alt))))
...
;;;;; jira (org-jira)
    ...
    `(jiralib-issue-info-face ((,class :inherit autumn-themes-special-warm)))
    `(jiralib-issue-info-header-face ((,class :inherit (autumn-themes-special-warm bold))))
...
;;;;; js2-mode
    `(js2-error ((,class :inherit autumn-themes-lang-error)))
    ...
    `(js2-warning ((,class :inherit autumn-themes-lang-warning)))
;;;;; julia
...
;;;;; jupyter
    ...
    `(jupyter-repl-traceback ((,class :inherit autumn-themes-intense-red)))
;;;;; kaocha-runner
...
;;;;; line numbers (display-line-numbers-mode and global variant)
    `(line-number
      ((,class :inherit default
               ,@(autumn-themes--line-numbers
                  line-number-fg line-number-bg
                  fg-unfocused))))
    `(line-number-current-line
      ((,class :inherit (bold default)
               ,@(autumn-themes--line-numbers
                  line-number-current-line-fg line-number-current-line-bg
                  blue-alt-other))))
    ...
    `(line-number-minor-tick
      ((,class :inherit (bold default)
               ,@(autumn-themes--line-numbers
                  ...
                  fg-inactive))))
;;;;; lsp-mode
    `(lsp-face-highlight-read ((,class :inherit autumn-themes-subtle-blue :underline t)))
    `(lsp-face-highlight-textual ((,class :inherit autumn-themes-subtle-blue)))
    `(lsp-face-highlight-write ((,class :inherit (autumn-themes-refine-blue bold))))
    `(lsp-face-semhl-constant ((,class :foreground ,blue-alt-other)))
    `(lsp-face-semhl-deprecated ((,class :inherit autumn-themes-lang-warning)))
    `(lsp-face-semhl-enummember ((,class :foreground ,blue-alt-other)))
    `(lsp-face-semhl-field ((,class :foreground ,cyan-alt)))
    `(lsp-face-semhl-field-static ((,class :inherit autumn-themes-slant :foreground ,cyan-alt)))
    `(lsp-face-semhl-function ((,class :foreground ,magenta)))
    `(lsp-face-semhl-method ((,class :foreground ,magenta)))
    `(lsp-face-semhl-namespace ((,class :inherit autumn-themes-bold :foreground ,magenta-alt)))
    `(lsp-face-semhl-preprocessor ((,class :foreground ,red-alt-other)))
    `(lsp-face-semhl-static-method ((,class :inherit autumn-themes-slant :foreground ,magenta)))
    `(lsp-face-semhl-type-class ((,class :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-enum ((,class :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-primitive ((,class :inherit autumn-themes-slant :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-template ((,class :inherit autumn-themes-slant :foreground ,magenta-alt)))
    `(lsp-face-semhl-type-typedef ((,class :inherit autumn-themes-slant :foreground ,magenta-alt)))
    ...
    `(lsp-ui-peek-highlight ((,class :inherit autumn-themes-subtle-blue)))
    ...
    `(lsp-ui-peek-selection ((,class :inherit autumn-themes-subtle-cyan)))
...
;;;;; magit
    ...
    `(magit-blame-dimmed ((,class :inherit (shadow autumn-themes-reset-hard))))
    `(magit-blame-hash ((,class :foreground ,fg-special-warm)))
    `(magit-blame-heading ((,class :inherit autumn-themes-reset-hard :background ,bg-alt :extend t)))
    `(magit-blame-highlight ((,class :inherit autumn-themes-nuanced-cyan)))
    `(magit-blame-margin ((,class :inherit (magit-blame-highlight autumn-themes-reset-hard))))
    ...
    ;; autumn-themes-diff-* faces, though only for the standard actions,
    ;; not the highlighted ones.  This is because Magit's interaction
    ;; model relies on highlighting the current diff hunk.
    `(magit-diff-added ((,class ,@(autumn-themes--diff
                                   bg-main blue-alt-other
                                   bg-diff-added fg-diff-added
                                   green-nuanced-bg fg-diff-added
                                   bg-diff-added-deuteran fg-diff-added-deuteran))))
    `(magit-diff-added-highlight ((,class :inherit autumn-themes-diff-focus-added)))
    `(magit-diff-base ((,class ,@(autumn-themes--diff
                                  bg-main yellow
                                  bg-diff-changed fg-diff-changed
                                  yellow-nuanced-bg fg-diff-changed))))
    `(magit-diff-base-highlight ((,class :inherit autumn-themes-diff-focus-changed)))
    `(magit-diff-context ((,class ,@(unless (eq autumn-themes-diffs 'bg-only) (list :foreground fg-unfocused)))))
    `(magit-diff-context-highlight ((,class ,@(autumn-themes--diff
                                               bg-dim fg-dim
                                               bg-inactive fg-inactive
                                               bg-dim fg-alt
                                               bg-dim fg-alt))))
    `(magit-diff-file-heading ((,class :inherit bold :foreground ,fg-special-cold)))
    `(magit-diff-file-heading-highlight ((,class :inherit (autumn-themes-special-cold bold))))
    `(magit-diff-file-heading-selection ((,class :inherit autumn-themes-refine-cyan)))
    ;; NOTE: here we break from the pattern of inheriting from the
    ;; autumn-themes-diff-* faces.
    ...
    `(magit-diff-hunk-heading-highlight
      ((,class :inherit bold
               :background ,@(autumn-themes--diff-deuteran bg-active bg-diff-heading)
               :foreground ,@(autumn-themes--diff-deuteran fg-main fg-diff-heading))))
    `(magit-diff-hunk-heading-selection ((,class :inherit autumn-themes-refine-blue)))
    `(magit-diff-hunk-region ((,class :inherit bold)))
    `(magit-diff-lines-boundary ((,class :background ,fg-main)))
    `(magit-diff-lines-heading ((,class :inherit autumn-themes-refine-magenta)))
    `(magit-diff-removed ((,class ,@(autumn-themes--diff
                                     bg-main red
                                     bg-diff-removed fg-diff-removed
                                     red-nuanced-bg fg-diff-removed))))
    `(magit-diff-removed-highlight ((,class :inherit autumn-themes-diff-focus-removed)))
    `(magit-diffstat-added ((,class :foreground ,@(autumn-themes--diff-deuteran blue green))))
    ...
    `(magit-header-line-key ((,class :inherit autumn-themes-key-binding)))
    ...
    `(magit-section-heading-selection ((,class :inherit (autumn-themes-refine-cyan bold))))
    `(magit-section-highlight ((,class :background ,bg-alt)))
    `(magit-sequence-done ((,class :foreground ,@(autumn-themes--success-deuteran
                                                  blue
                                                  green))))
    ...
    `(magit-signature-good ((,class :foreground ,@(autumn-themes--success-deuteran
                                                   blue
                                                   green))))
...
;;;;; man
    ...
    `(Man-reverse ((,class :inherit autumn-themes-subtle-magenta)))
...
;;;;; marginalia
    ...
    `(marginalia-documentation ((,class :inherit autumn-themes-slant :foreground ,fg-docstring)))
    ...
    ;; `autumn-themes-key-binding' for two reasons: (1) completion
...
;;;;; markdown-mode
    `(markdown-blockquote-face ((,class :inherit autumn-themes-slant :foreground ,fg-special-cold)))
    `(markdown-bold-face ((,class :inherit bold)))
    `(markdown-code-face ((,class :inherit autumn-themes-fixed-pitch :background ,bg-dim :extend t)))
    ...
    `(markdown-footnote-text-face ((,class :inherit autumn-themes-slant :foreground ,fg-main)))
    `(markdown-gfm-checkbox-face ((,class :foreground ,cyan-alt-other)))
    `(markdown-header-delimiter-face ((,class :inherit autumn-themes-bold :foreground ,fg-dim)))
    `(markdown-header-face ((t nil)))
    `(markdown-header-face-1 ((,class :inherit autumn-themes-heading-1)))
    `(markdown-header-face-2 ((,class :inherit autumn-themes-heading-2)))
    `(markdown-header-face-3 ((,class :inherit autumn-themes-heading-3)))
    `(markdown-header-face-4 ((,class :inherit autumn-themes-heading-4)))
    `(markdown-header-face-5 ((,class :inherit autumn-themes-heading-5)))
    `(markdown-header-face-6 ((,class :inherit autumn-themes-heading-6)))
    ...
    `(markdown-html-attr-name-face ((,class :inherit autumn-themes-fixed-pitch
                                            :foreground ,cyan)))
    `(markdown-html-attr-value-face ((,class :inherit autumn-themes-fixed-pitch
                                             :foreground ,blue)))
    `(markdown-html-entity-face ((,class :inherit autumn-themes-fixed-pitch
                                         :foreground ,cyan)))
    `(markdown-html-tag-delimiter-face ((,class :inherit autumn-themes-fixed-pitch
                                                :foreground ,fg-special-mild)))
    `(markdown-html-tag-name-face ((,class :inherit autumn-themes-fixed-pitch
                                           :foreground ,magenta-alt)))
    `(markdown-inline-code-face ((,class :inherit autumn-themes-fixed-pitch
                                         :background ,bg-alt :foreground ,fg-special-calm)))
    `(markdown-italic-face ((,class :inherit italic)))
    `(markdown-language-info-face ((,class :inherit autumn-themes-fixed-pitch
                                           :foreground ,fg-special-cold)))
    `(markdown-language-keyword-face ((,class :inherit autumn-themes-fixed-pitch
                                              :background ,bg-alt
                                              :foreground ,fg-alt)))
    `(markdown-line-break-face ((,class :inherit autumn-themes-refine-cyan :underline t)))
    `(markdown-link-face ((,class :inherit button)))
    `(markdown-link-title-face ((,class :inherit autumn-themes-slant :foreground ,fg-special-cold)))
    ...
    `(markdown-table-face ((,class :inherit autumn-themes-fixed-pitch
                                   :foreground ,fg-special-cold)))
...
;;;;; markup-faces (`adoc-mode')
    ...
    `(markup-list-face ((,class :inherit autumn-themes-special-cold)))
    ...
    `(markup-table-cell-face ((,class :inherit autumn-themes-subtle-neutral)))
    `(markup-table-face ((,class :inherit autumn-themes-subtle-neutral)))
    `(markup-table-row-face ((,class :inherit autumn-themes-special-cold)))
    `(markup-title-0-face ((,class :inherit (bold autumn-themes-variable-pitch)
                                   :foreground ,blue-nuanced-fg
                                   ,@(autumn-themes--scale autumn-themes-scale-title))))
    `(markup-title-1-face ((,class :inherit (bold autumn-themes-variable-pitch)
                                   :foreground ,blue-nuanced-fg
                                   ,@(autumn-themes--scale autumn-themes-scale-1))))
    `(markup-title-2-face ((,class :inherit (bold autumn-themes-variable-pitch)
                                   :foreground ,blue-nuanced-fg
                                   ,@(autumn-themes--scale autumn-themes-scale-2))))
    `(markup-title-3-face ((,class :inherit (bold autumn-themes-variable-pitch)
                                   :foreground ,blue-nuanced-fg
                                   ,@(autumn-themes--scale autumn-themes-scale-3))))
    `(markup-title-4-face ((,class :inherit (bold autumn-themes-variable-pitch)
                                   :foreground ,blue-nuanced-fg
                                   ,@(autumn-themes--scale autumn-themes-scale-4))))
    `(markup-title-5-face ((,class :inherit (bold autumn-themes-variable-pitch)
                                   :foreground ,blue-nuanced-fg)))
...
;;;;; mentor
    ...
    `(mentor-highlight-face ((,class :inherit autumn-themes-subtle-blue)))
    `(mentor-tracker-name ((,class :foreground ,magenta-alt)))
;;;;; messages
    `(message-cited-text-1 ((,class ,@(autumn-themes--mail-cite blue-faint fg-alt))))
    `(message-cited-text-2 ((,class ,@(autumn-themes--mail-cite green-faint fg-comment-yellow))))
    `(message-cited-text-3 ((,class ,@(autumn-themes--mail-cite red-faint fg-special-cold))))
    `(message-cited-text-4 ((,class ,@(autumn-themes--mail-cite yellow-faint fg-special-calm))))
    ...
    `(message-separator ((,class :inherit autumn-themes-intense-neutral)))
;;;;; minibuffer-line
...
;;;;; mode-line
    `(mode-line ((,class ,@(autumn-themes--variable-pitch-ui)
                         ,@(autumn-themes--mode-line-attrs
                            fg-active bg-active
                            fg-dim bg-active
    ...
    `(mode-line-highlight ((,class :inherit autumn-themes-active-blue :box (:line-width -1 :style pressed-button))))
    `(mode-line-inactive ((,class ,@(autumn-themes--variable-pitch-ui)
                                  ,@(autumn-themes--mode-line-attrs
...
;;;;; mood-line
    ...
    `(mood-line-status-success ((,class :foreground ,@(autumn-themes--success-deuteran
                                                       blue-active
                                                       green-active))))
...
;;;;; mu4e
    ...
    `(mu4e-compose-separator-face ((,class :inherit autumn-themes-intense-neutral)))
    ...
    `(mu4e-footer-face ((,class :inherit autumn-themes-slant :foreground ,fg-special-cold)))
    `(mu4e-forwarded-face ((,class :foreground ,magenta-alt-other)))
    `(mu4e-header-face ((,class :inherit shadow)))
    `(mu4e-header-highlight-face ((,class :inherit autumn-themes-hl-line)))
    ...
    `(mu4e-highlight-face ((,class :inherit autumn-themes-key-binding)))
    `(mu4e-link-face ((,class :inherit button)))
    `(mu4e-modeline-face ((,class :foreground ,magenta-active)))
    `(mu4e-moved-face ((,class :inherit autumn-themes-slant :foreground ,yellow)))
    `(mu4e-ok-face ((,class :inherit bold :foreground ,green)))
    `(mu4e-region-code ((,class :inherit autumn-themes-special-calm)))
    `(mu4e-replied-face ((,class :foreground ,blue)))
    `(mu4e-special-header-value-face ((,class :inherit message-header-subject)))
    `(mu4e-system-face ((,class :inherit autumn-themes-slant :foreground ,fg-mark-del)))
...
;;;;; mu4e-conversation
    `(mu4e-conversation-header ((,class :inherit autumn-themes-special-cold)))
...
;;;;; neotree
    ...
    `(neo-vc-added-face ((,class :foreground ,@(autumn-themes--diff-deuteran blue green))))
    ...
    `(neo-vc-unlocked-changes-face ((,class :inherit autumn-themes-refine-blue)))
...
;;;;; notmuch
    ...
    `(notmuch-jump-key ((,class :inherit autumn-themes-key-binding)))
    `(notmuch-message-summary-face ((,class :inherit (bold autumn-themes-nuanced-cyan))))
...
;;;;; nxml-mode
    ...
    `(nxml-char-ref-number ((,class :inherit autumn-themes-bold :foreground ,fg-special-mild)))
    `(nxml-delimited-data ((,class :inherit autumn-themes-slant :foreground ,fg-special-cold)))
    ...
    `(nxml-entity-ref-name ((,class :inherit autumn-themes-bold :foreground ,fg-special-mild)))
    `(nxml-glyph ((,class :inherit autumn-themes-intense-neutral)))
    ...
    `(nxml-ref ((,class :inherit autumn-themes-bold :foreground ,fg-special-mild)))
    `(rng-error ((,class :inherit error)))
;;;;; objed
    `(objed-hl ((,class :background ,(if autumn-themes-hl-line bg-hl-alt-intense bg-hl-alt))))
...
;;;;; org
    `(org-agenda-calendar-event ((,class ,@(autumn-themes--agenda-event blue-alt))))
    `(org-agenda-calendar-sexp ((,class :inherit org-agenda-calendar-event)))
    `(org-agenda-clocking ((,class :inherit autumn-themes-special-cold :extend t)))
    `(org-agenda-column-dateline ((,class :background ,bg-alt)))
    `(org-agenda-current-time ((,class :foreground ,blue-alt-other-faint)))
    `(org-agenda-date ((,class ,@(autumn-themes--agenda-date cyan fg-main))))
    `(org-agenda-date-today ((,class ,@(autumn-themes--agenda-date blue-active fg-main
                                                                  cyan-active fg-main
                                                                  bg-active t t))))
    `(org-agenda-date-weekend ((,class ,@(autumn-themes--agenda-date cyan-alt-other fg-alt
                                                                    cyan fg-main))))
    `(org-agenda-diary ((,class :inherit org-agenda-calendar-event)))
    `(org-agenda-dimmed-todo-face ((,class :inherit shadow)))
    `(org-agenda-done ((,class :foreground ,@(autumn-themes--success-deuteran
                                              blue-nuanced-fg
                                              green-nuanced-fg))))
    ...
    `(org-agenda-structure ((,class ,@(autumn-themes--agenda-structure blue-alt))))
    `(org-archived ((,class :background ,bg-alt :foreground ,fg-alt)))
    `(org-block ((,class :inherit autumn-themes-fixed-pitch
                         ,@(autumn-themes--org-block bg-dim fg-main))))
    `(org-block-begin-line ((,class :inherit autumn-themes-fixed-pitch
                                    ,@(autumn-themes--org-block-delim
    ...
    `(org-clock-overlay ((,class :inherit autumn-themes-special-cold)))
    `(org-code ((,class :inherit autumn-themes-fixed-pitch
                        :background ,bg-alt :foreground ,fg-special-mild
                        :extend t)))
    `(org-column ((,class :background ,bg-alt)))
    `(org-column-title ((,class :inherit bold :underline t :background ,bg-alt)))
    `(org-date ((,class :inherit ,(if autumn-themes-no-mixed-fonts
                                      'button
                                    '(button fixed-pitch))
                        ,@(autumn-themes--link-color
                           cyan cyan-faint))))
    `(org-date-selected ((,class :inherit bold :foreground ,blue-alt :inverse-video t)))
    `(org-dispatcher-highlight ((,class :inherit (bold autumn-themes-mark-alt))))
    `(org-document-info ((,class :foreground ,fg-special-cold)))
    `(org-document-info-keyword ((,class :inherit autumn-themes-fixed-pitch :foreground ,fg-alt)))
    `(org-document-title ((,class :inherit (bold autumn-themes-variable-pitch) :foreground ,fg-special-cold
                                  ,@(autumn-themes--scale autumn-themes-scale-title))))
    `(org-done ((,class :foreground ,@(autumn-themes--success-deuteran blue green))))
    `(org-drawer ((,class :inherit autumn-themes-fixed-pitch :foreground ,fg-alt)))
    `(org-ellipsis (())) ; inherits from the heading's color
    `(org-footnote ((,class :inherit button
                            ,@(autumn-themes--link-color
                               blue-alt blue-alt-faint))))
    `(org-formula ((,class :inherit autumn-themes-fixed-pitch :foreground ,red-alt)))
    `(org-habit-alert-face ((,class ,@(autumn-themes--agenda-habit
                                       yellow-graph-0-bg
                                       yellow-graph-0-bg
                                       yellow-graph-1-bg))))
    `(org-habit-alert-future-face ((,class ,@(autumn-themes--agenda-habit
                                              yellow-graph-1-bg
                                              yellow-graph-0-bg
                                              yellow-graph-1-bg))))
    `(org-habit-clear-face ((,class ,@(autumn-themes--agenda-habit
                                       blue-graph-0-bg
                                       green-graph-1-bg
                                       blue-graph-1-bg
                                       blue-graph-1-bg))))
    `(org-habit-clear-future-face ((,class ,@(autumn-themes--agenda-habit
                                              blue-graph-1-bg
                                              green-graph-1-bg
                                              blue-graph-1-bg
                                              blue-graph-1-bg))))
    `(org-habit-overdue-face ((,class ,@(autumn-themes--agenda-habit
                                         red-graph-0-bg
                                         red-graph-0-bg
                                         red-graph-1-bg))))
    `(org-habit-overdue-future-face ((,class ,@(autumn-themes--agenda-habit
                                                red-graph-1-bg
                                                red-graph-0-bg
                                                red-graph-1-bg))))
    `(org-habit-ready-face ((,class ,@(autumn-themes--agenda-habit
                                       green-graph-0-bg
                                       green-graph-0-bg
                                       green-graph-1-bg
                                       blue-graph-0-bg))))
    `(org-habit-ready-future-face ((,class ,@(autumn-themes--agenda-habit
                                              green-graph-1-bg
                                              green-graph-0-bg
                                              green-graph-1-bg
                                              blue-graph-0-bg))))
    `(org-headline-done ((,class :inherit autumn-themes-variable-pitch
                                 :foreground ,@(autumn-themes--success-deuteran
                                                blue-nuanced-fg
                                                green-nuanced-fg))))
    `(org-headline-todo ((,class :inherit autumn-themes-variable-pitch :foreground ,red-nuanced-fg)))
    `(org-hide ((,class :foreground ,bg-main)))
    `(org-indent ((,class :inherit (fixed-pitch org-hide))))
    `(org-latex-and-related ((,class :foreground ,magenta-refine-fg)))
    `(org-level-1 ((,class :inherit autumn-themes-heading-1)))
    `(org-level-2 ((,class :inherit autumn-themes-heading-2)))
    `(org-level-3 ((,class :inherit autumn-themes-heading-3)))
    `(org-level-4 ((,class :inherit autumn-themes-heading-4)))
    `(org-level-5 ((,class :inherit autumn-themes-heading-5)))
    `(org-level-6 ((,class :inherit autumn-themes-heading-6)))
    `(org-level-7 ((,class :inherit autumn-themes-heading-7)))
    `(org-level-8 ((,class :inherit autumn-themes-heading-8)))
    `(org-link ((,class :inherit button)))
    `(org-list-dt ((,class :inherit bold)))
    `(org-macro ((,class :inherit autumn-themes-fixed-pitch
                         :background ,cyan-nuanced-bg :foreground ,cyan-nuanced-fg)))
    `(org-meta-line ((,class :inherit autumn-themes-fixed-pitch :foreground ,fg-alt)))
    `(org-mode-line-clock ((,class :foreground ,fg-main)))
    `(org-mode-line-clock-overrun ((,class :inherit bold :foreground ,red-active)))
    `(org-priority ((,class :foreground ,magenta)))
    `(org-property-value ((,class :inherit autumn-themes-fixed-pitch :foreground ,fg-special-cold)))
    `(org-quote ((,class ,@(autumn-themes--org-block bg-dim fg-special-cold fg-main))))
    `(org-scheduled ((,class ,@(autumn-themes--agenda-scheduled yellow-faint fg-special-warm magenta-alt))))
    `(org-scheduled-previously ((,class ,@(autumn-themes--agenda-scheduled yellow fg-special-warm yellow-alt-other))))
    `(org-scheduled-today ((,class ,@(autumn-themes--agenda-scheduled yellow fg-special-warm magenta-alt-other))))
    `(org-sexp-date ((,class :inherit org-date)))
    `(org-special-keyword ((,class :inherit autumn-themes-fixed-pitch :foreground ,fg-alt)))
    `(org-table ((,class :inherit autumn-themes-fixed-pitch :foreground ,fg-special-cold)))
    `(org-table-header ((,class :inherit (fixed-pitch autumn-themes-intense-neutral))))
    ...
    `(org-verbatim ((,class :inherit autumn-themes-fixed-pitch
                            :background ,bg-alt :foreground ,fg-special-calm)))
    `(org-verse ((,class :inherit org-quote)))
    `(org-warning ((,class :inherit bold :foreground ,red-alt-other)))
;;;;; org-journal
    `(org-journal-calendar-entry-face ((,class :inherit autumn-themes-slant :foreground ,yellow-alt-other)))
    `(org-journal-calendar-scheduled-face ((,class :inherit autumn-themes-slant :foreground ,red-alt-other)))
...
;;;;; org-table-sticky-header
    `(org-table-sticky-header-face ((,class :inherit autumn-themes-intense-neutral)))
;;;;; org-tree-slide
    `(org-tree-slide-header-overlay-face
      ((,class :inherit (bold autumn-themes-variable-pitch) :background ,bg-main
               :foreground ,fg-special-cold :overline nil
               ,@(autumn-themes--scale autumn-themes-scale-title))))
;;;;; org-treescope
    `(org-treescope-faces--markerinternal-midday ((,class :inherit autumn-themes-intense-blue)))
    `(org-treescope-faces--markerinternal-range ((,class :inherit autumn-themes-special-mild)))
;;;;; origami
...
;;;;; outline-mode
    `(outline-1 ((,class :inherit autumn-themes-heading-1)))
    `(outline-2 ((,class :inherit autumn-themes-heading-2)))
    `(outline-3 ((,class :inherit autumn-themes-heading-3)))
    `(outline-4 ((,class :inherit autumn-themes-heading-4)))
    `(outline-5 ((,class :inherit autumn-themes-heading-5)))
    `(outline-6 ((,class :inherit autumn-themes-heading-6)))
    `(outline-7 ((,class :inherit autumn-themes-heading-7)))
    `(outline-8 ((,class :inherit autumn-themes-heading-8)))
;;;;; outline-minor-faces
    `(outline-minor-0 (()))
;;;;; package (M-x list-packages)
    ...
    `(package-status-disabled ((,class :inherit autumn-themes-subtle-red)))
...
;;;;; paradox
    ...
    `(paradox-commit-tag-face ((,class :inherit autumn-themes-refine-magenta :box t)))
    ...
    `(paradox-download-face ((,class :inherit autumn-themes-bold :foreground ,blue-alt-other)))
    `(paradox-highlight-face ((,class :inherit autumn-themes-bold :foreground ,cyan-alt-other)))
...
;;;;; parrot
    `(parrot-rotate-rotation-highlight-face ((,class :inherit autumn-themes-refine-magenta)))
;;;;; pass
...
;;;;; persp-mode
    `(persp-face-lighter-buffer-not-in-persp ((,class :inherit autumn-themes-intense-red)))
...
;;;;; phi-grep
    ...
    `(phi-grep-match-face ((,class :inherit autumn-themes-special-calm)))
    `(phi-grep-modified-face ((,class :inherit autumn-themes-refine-yellow)))
    `(phi-grep-overlay-face ((,class :inherit autumn-themes-refine-blue)))
;;;;; phi-search
    `(phi-replace-preview-face ((,class :inherit autumn-themes-intense-magenta)))
    `(phi-search-failpart-face ((,class :inherit autumn-themes-refine-red)))
    `(phi-search-match-face ((,class :inherit autumn-themes-search-success-lazy)))
    `(phi-search-selection-face ((,class :inherit (autumn-themes-search-success bold))))
;;;;; pkgbuild-mode
    `(pkgbuild-error-face ((,class :inherit autumn-themes-lang-error)))
;;;;; pomidor
    `(pomidor-break-face ((,class :foreground ,blue-alt-other)))
    `(pomidor-overwork-face ((,class :foreground ,red-alt-other)))
    `(pomidor-skip-face ((,class :inherit autumn-themes-slant :foreground ,fg-alt)))
    `(pomidor-work-face ((,class :foreground ,@(autumn-themes--success-deuteran
                                                blue-alt
                                                green-alt-other))))
;;;;; popup
    `(popup-face ((,class :background ,bg-alt :foreground ,fg-main)))
    `(popup-isearch-match ((,class :inherit (autumn-themes-refine-cyan bold))))
    `(popup-menu-mouse-face ((,class :inherit autumn-themes-intense-blue)))
    `(popup-menu-selection-face ((,class :inherit (autumn-themes-subtle-cyan bold))))
    ...
    `(popup-tip-face ((,class :inherit autumn-themes-refine-yellow)))
;;;;; powerline
...
;;;;; powerline-evil
    ...
    `(powerline-evil-emacs-face ((,class :inherit autumn-themes-active-magenta)))
    `(powerline-evil-insert-face ((,class :inherit autumn-themes-active-green)))
    `(powerline-evil-motion-face ((,class :inherit autumn-themes-active-blue)))
    `(powerline-evil-normal-face ((,class :background ,fg-alt :foreground ,bg-main)))
    `(powerline-evil-operator-face ((,class :inherit autumn-themes-active-yellow)))
    `(powerline-evil-replace-face ((,class :inherit autumn-themes-active-red)))
    `(powerline-evil-visual-face ((,class :inherit autumn-themes-active-cyan)))
;;;;; proced
    `(proced-mark ((,class :inherit autumn-themes-mark-symbol)))
    `(proced-marked ((,class :inherit autumn-themes-mark-alt)))
...
;;;;; racket-mode
    `(racket-debug-break-face ((,class :inherit autumn-themes-intense-red)))
    ...
    `(racket-logger-config-face ((,class :inherit autumn-themes-slant :foreground ,fg-alt)))
    `(racket-logger-debug-face ((,class :foreground ,blue-alt-other)))
    `(racket-logger-info-face ((,class :foreground ,fg-lang-note)))
    `(racket-logger-topic-face ((,class :inherit autumn-themes-slant :foreground ,magenta)))
    `(racket-selfeval-face ((,class :foreground ,green-alt)))
    `(racket-xp-error-face ((,class :inherit autumn-themes-lang-error)))
;;;;; rainbow-blocks
...
;;;;; rainbow-delimiters
    ...
    `(rainbow-delimiters-mismatched-face ((,class :inherit (bold autumn-themes-refine-yellow))))
    `(rainbow-delimiters-unmatched-face ((,class :inherit (bold autumn-themes-refine-red))))
;;;;; rcirc
    ...
    `(rcirc-prompt ((,class :inherit autumn-themes-prompt)))
...
;;;;; regexp-builder (re-builder)
    `(reb-match-0 ((,class :inherit autumn-themes-refine-cyan)))
    `(reb-match-1 ((,class :inherit autumn-themes-subtle-magenta)))
    `(reb-match-2 ((,class :inherit autumn-themes-subtle-green)))
    `(reb-match-3 ((,class :inherit autumn-themes-refine-yellow)))
...
;;;;; rg (rg.el)
    ...
    `(rg-match-face ((,class :inherit autumn-themes-special-calm)))
...
;;;;; ripgrep
    ...
    `(ripgrep-match-face ((,class :inherit autumn-themes-special-calm)))
;;;;; rmail
...
;;;;; sallet
    ...
    `(sallet-flx-match ((,class ,@(autumn-themes--extra-completions
                                   'autumn-themes-subtle-cyan
                                   'autumn-themes-refine-cyan
                                   'autumn-themes-nuanced-cyan
                                   cyan-alt-other))))
    ...
    `(sallet-regexp-match ((,class ,@(autumn-themes--extra-completions
                                      'autumn-themes-subtle-magenta
                                      'autumn-themes-refine-magenta
                                      'autumn-themes-nuanced-magenta
                                      magenta-alt-other))))
    `(sallet-source-header ((,class :inherit bold :foreground ,red-alt
                                    ,@(autumn-themes--scale autumn-themes-scale-4))))
    `(sallet-substring-match ((,class ,@(autumn-themes--extra-completions
                                         'autumn-themes-subtle-blue
                                         'autumn-themes-refine-blue
                                         'autumn-themes-nuanced-blue
                                         blue-alt-other))))
;;;;; selectrum
    ...
    `(selectrum-quick-keys-highlight
      ((,class :inherit autumn-themes-refine-red)))
    `(selectrum-quick-keys-match
      ((,class :inherit (bold autumn-themes-search-success))))
;;;;; selectrum-prescient
...
;;;;; semantic
    ...
    `(semantic-decoration-on-fileless-includes ((,class :inherit autumn-themes-refine-green)))
    `(semantic-decoration-on-private-members-face ((,class :inherit autumn-themes-refine-cyan)))
    `(semantic-decoration-on-protected-members-face ((,class :background ,bg-dim)))
    `(semantic-decoration-on-unknown-includes ((,class :inherit autumn-themes-refine-red)))
    `(semantic-decoration-on-unparsed-includes ((,class :inherit autumn-themes-refine-yellow)))
    `(semantic-highlight-edits-face ((,class :background ,bg-alt)))
    `(semantic-highlight-func-current-tag-face ((,class :background ,bg-alt)))
    `(semantic-idle-symbol-highlight ((,class :inherit autumn-themes-special-mild)))
...
;;;;; sesman
    ...
    `(sesman-browser-highligh-face ((,class :inherit autumn-themes-subtle-blue)))
...
;;;;; shell-script-mode
    ...
    `(sh-quoted-exec ((,class :inherit autumn-themes-bold :foreground ,magenta-alt)))
;;;;; shortdoc
    `(shortdoc-heading ((,class :inherit autumn-themes-pseudo-header)))
    `(shortdoc-section (())) ; remove the default's variable-pitch style
;;;;; show-paren-mode
    `(show-paren-match ((,class ,@(autumn-themes--paren bg-paren-match
                                                       bg-paren-match-intense)
                                :foreground ,fg-main)))
    `(show-paren-match-expression ((,class :background ,bg-paren-expression)))
    `(show-paren-mismatch ((,class :inherit autumn-themes-intense-red)))
;;;;; shr
    `(shr-h1 ((,class :inherit autumn-themes-heading-1)))
    `(shr-h2 ((,class :inherit autumn-themes-heading-2)))
    `(shr-h3 ((,class :inherit autumn-themes-heading-3)))
    `(shr-h4 ((,class :inherit autumn-themes-heading-4)))
    `(shr-h5 ((,class :inherit autumn-themes-heading-5)))
    `(shr-h6 ((,class :inherit autumn-themes-heading-6)))
    `(shr-abbreviation ((,class :inherit autumn-themes-lang-note)))
    `(shr-selected-link ((,class :inherit autumn-themes-subtle-red)))
;;;;; side-notes
...
;;;;; smart-mode-line
    ...
    `(sml/outside-modified ((,class :inherit autumn-themes-intense-red)))
    ...
    `(sml/sudo ((,class :inherit autumn-themes-subtle-red)))
    `(sml/time ((,class :inherit sml/global)))
    `(sml/vc ((,class :inherit sml/git)))
    `(sml/vc-edited ((,class :inherit bold :foreground ,yellow-active)))
;;;;; smartparens
    `(sp-pair-overlay-face ((,class :inherit autumn-themes-special-warm)))
    `(sp-show-pair-enclosing ((,class :inherit autumn-themes-special-mild)))
    `(sp-show-pair-match-face ((,class ,@(autumn-themes--paren bg-paren-match
                                                              bg-paren-match-intense)
                                       :foreground ,fg-main)))
    `(sp-show-pair-mismatch-face ((,class :inherit autumn-themes-intense-red)))
...
;;;;; smerge
    `(smerge-base ((,class :inherit autumn-themes-diff-changed)))
    `(smerge-lower ((,class :inherit autumn-themes-diff-added)))
    `(smerge-markers ((,class :inherit autumn-themes-diff-heading)))
    `(smerge-refined-added ((,class :inherit autumn-themes-diff-refine-added)))
    `(smerge-refined-changed (()))
    `(smerge-refined-removed ((,class :inherit autumn-themes-diff-refine-removed)))
    `(smerge-upper ((,class :inherit autumn-themes-diff-removed)))
;;;;; solaire
...
;;;;; spaceline
    `(spaceline-evil-emacs ((,class :inherit autumn-themes-active-magenta)))
    `(spaceline-evil-insert ((,class :inherit autumn-themes-active-green)))
    `(spaceline-evil-motion ((,class :inherit autumn-themes-active-blue)))
    `(spaceline-evil-normal ((,class :background ,fg-alt :foreground ,bg-alt)))
    `(spaceline-evil-replace ((,class :inherit autumn-themes-active-red)))
    `(spaceline-evil-visual ((,class :inherit autumn-themes-active-cyan)))
    ...
    `(spaceline-highlight-face ((,class :inherit autumn-themes-fringe-blue)))
    `(spaceline-modified ((,class :inherit autumn-themes-fringe-magenta)))
    `(spaceline-python-venv ((,class :foreground ,magenta-active)))
    `(spaceline-read-only ((,class :inherit autumn-themes-fringe-red)))
    `(spaceline-unmodified ((,class :inherit autumn-themes-fringe-cyan)))
;;;;; speedbar
    ...
    `(speedbar-highlight-face ((,class :inherit autumn-themes-subtle-blue)))
    `(speedbar-selected-face ((,class :inherit bold :foreground ,cyan)))
    `(speedbar-separator-face ((,class :inherit autumn-themes-intense-neutral)))
    `(speedbar-tag-face ((,class :foreground ,yellow-alt-other)))
;;;;; spell-fu
    `(spell-fu-incorrect-face ((,class :inherit autumn-themes-lang-error)))
;;;;; spray
...
;;;;; swiper
    `(swiper-background-match-face-1 ((,class :inherit autumn-themes-subtle-neutral)))
    `(swiper-background-match-face-2 ((,class :inherit autumn-themes-refine-cyan)))
    `(swiper-background-match-face-3 ((,class :inherit autumn-themes-refine-magenta)))
    `(swiper-background-match-face-4 ((,class :inherit autumn-themes-refine-yellow)))
    `(swiper-line-face ((,class :inherit autumn-themes-special-cold)))
    `(swiper-match-face-1 ((,class :inherit (bold autumn-themes-intense-neutral))))
    `(swiper-match-face-2 ((,class :inherit (bold autumn-themes-intense-green))))
    `(swiper-match-face-3 ((,class :inherit (bold autumn-themes-intense-blue))))
    `(swiper-match-face-4 ((,class :inherit (bold autumn-themes-intense-red))))
;;;;; swoop
    ...
    `(swoop-face-target-line ((,class :inherit autumn-themes-intense-blue :extend t)))
    `(swoop-face-target-words ((,class :inherit autumn-themes-refine-cyan)))
;;;;; sx
    ...
    `(sx-question-mode-closed ((,class :inherit autumn-themes-active-yellow :box (:line-width 2 :color nil))))
...
;;;;; symbol-overlay
    `(symbol-overlay-default-face ((,class :inherit autumn-themes-special-warm)))
    `(symbol-overlay-face-1 ((,class :inherit autumn-themes-intense-blue)))
    `(symbol-overlay-face-2 ((,class :inherit autumn-themes-refine-magenta)))
    `(symbol-overlay-face-3 ((,class :inherit autumn-themes-intense-yellow)))
    `(symbol-overlay-face-4 ((,class :inherit autumn-themes-intense-magenta)))
    `(symbol-overlay-face-5 ((,class :inherit autumn-themes-intense-red)))
    `(symbol-overlay-face-6 ((,class :inherit autumn-themes-refine-red)))
    `(symbol-overlay-face-7 ((,class :inherit autumn-themes-intense-cyan)))
    `(symbol-overlay-face-8 ((,class :inherit autumn-themes-refine-cyan)))
;;;;; syslog-mode
...
;;;;; tab-bar-groups
    `(tab-bar-groups-tab-1 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,blue-tab)))
    `(tab-bar-groups-tab-2 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,red-tab)))
    `(tab-bar-groups-tab-3 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,green-tab)))
    `(tab-bar-groups-tab-4 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,orange-tab)))
    `(tab-bar-groups-tab-5 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,purple-tab)))
    `(tab-bar-groups-tab-6 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,cyan-tab)))
    `(tab-bar-groups-tab-7 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,yellow-tab)))
    `(tab-bar-groups-tab-8 ((,class ,@(autumn-themes--variable-pitch-ui) :foreground ,magenta-tab)))
;;;;; tab-bar-mode
    `(tab-bar ((,class ,@(autumn-themes--tab bg-active bg-active-accent nil nil nil nil t))))
    `(tab-bar-tab-group-current ((,class ,@(autumn-themes--tab bg-tab-active)
                                         :box (:line-width (2 . -2) :color "gray50"))))
    `(tab-bar-tab-group-inactive ((,class ,@(autumn-themes--tab bg-tab-inactive bg-tab-inactive-accent fg-dim)
                                          :box (:line-width (2 . -2) :color "gray50"))))
    `(tab-bar-tab ((,class ,@(autumn-themes--tab bg-tab-active nil nil nil t t))))
    `(tab-bar-tab-inactive ((,class ,@(autumn-themes--tab bg-tab-inactive bg-tab-inactive-accent fg-dim nil t))))
;;;;; tab-line-mode
    `(tab-line ((,class ,@(autumn-themes--tab bg-active bg-active-accent nil nil nil nil t)
                        :height 0.95)))
    `(tab-line-close-highlight ((,class :foreground ,red)))
    `(tab-line-highlight ((,class :inherit autumn-themes-active-blue)))
    `(tab-line-tab ((,class ,@(autumn-themes--tab bg-tab-active nil nil nil t t))))
    `(tab-line-tab-current ((,class :inherit tab-line-tab)))
    `(tab-line-tab-inactive ((,class ,@(autumn-themes--tab bg-tab-inactive bg-tab-inactive-accent fg-dim nil t))))
    `(tab-line-tab-inactive-alternate ((,class ,@(autumn-themes--tab bg-tab-inactive-alt
...
;;;;; telega
    ...
    `(telega-button-highlight ((,class :inherit autumn-themes-subtle-magenta)))
    ...
    `(telega-root-heading ((,class :inherit autumn-themes-subtle-neutral)))
    ...
    `(telega-webpage-header ((,class :inherit autumn-themes-variable-pitch :height 1.3)))
    `(telega-webpage-preformatted ((,class :inherit fixed-pitch :background ,bg-alt)))
    `(telega-webpage-subheader ((,class :inherit autumn-themes-variable-pitch :height 1.15)))
;;;;; telephone-line
...
;;;;; terraform-mode
    `(terraform--resource-name-face ((,class ,@(autumn-themes--syntax-string
                                                magenta-alt-other magenta-alt-other-faint
                                                red-alt red-alt))))
    `(terraform--resource-type-face ((,class ,@(autumn-themes--syntax-string
                                                green green-faint
...
;;;;; transient
    `(transient-active-infix ((,class :inherit autumn-themes-special-mild)))
    ...
    `(transient-disabled-suffix ((,class :inherit autumn-themes-intense-red)))
    `(transient-enabled-suffix ((,class :inherit ,@(autumn-themes--success-deuteran
                                                    'autumn-themes-subtle-blue
                                                    'autumn-themes-subtle-green))))
    ...
    ;; FIXME 2021-08-28: using `autumn-themes-key-binding' leads to
    ;; misalignments because of the added box property.
    ;; `(transient-key ((,class :inherit autumn-themes-key-binding)))
...
;;;;; trashed
    `(trashed-deleted ((,class :inherit autumn-themes-mark-del)))
    `(trashed-directory ((,class :foreground ,blue)))
    `(trashed-mark ((,class :inherit autumn-themes-mark-symbol)))
    `(trashed-marked ((,class :inherit autumn-themes-mark-alt)))
    `(trashed-restored ((,class :inherit autumn-themes-mark-sel)))
...
;;;;; treemacs
    ...
    `(treemacs-git-conflict-face ((,class :inherit (autumn-themes-intense-red bold))))
    ...
    `(treemacs-help-column-face ((,class :inherit autumn-themes-bold :foreground ,magenta-alt-other :underline t)))
    `(treemacs-help-title-face ((,class :foreground ,blue-alt-other)))
    `(treemacs-on-failure-pulse-face ((,class :inherit autumn-themes-intense-red)))
    `(treemacs-on-success-pulse-face ((,class :inherit ,@(autumn-themes--success-deuteran
                                                          'autumn-themes-intense-blue
                                                          'autumn-themes-intense-green))))
...
;;;;; tty-menu
    ...
    `(tty-menu-selected-face ((,class :inherit autumn-themes-intense-blue)))
;;;;; tuareg
    `(caml-types-def-face ((,class :inherit autumn-themes-subtle-red)))
    `(caml-types-expr-face ((,class :inherit autumn-themes-subtle-green)))
    `(caml-types-occ-face ((,class :inherit autumn-themes-subtle-green)))
    `(caml-types-scope-face ((,class :inherit autumn-themes-subtle-blue)))
    `(caml-types-typed-face ((,class :inherit autumn-themes-subtle-magenta)))
    ...
    `(tuareg-font-lock-error-face ((,class :inherit (autumn-themes-intense-red bold))))
...
;;;;; vc (vc-dir.el, vc-hooks.el)
    ...
    `(vc-conflict-state ((,class :inherit autumn-themes-slant :foreground ,red-active)))
    ...
    `(vc-missing-state ((,class :inherit autumn-themes-slant :foreground ,magenta-active)))
    `(vc-needs-update-state ((,class :inherit autumn-themes-slant :foreground ,green-active)))
    `(vc-removed-state ((,class :foreground ,red-active)))
    `(vc-state-base ((,class :foreground ,fg-active)))
    `(vc-up-to-date-state ((,class :foreground ,fg-special-cold)))
;;;;; vdiff
    `(vdiff-addition-face ((,class :inherit autumn-themes-diff-added)))
    `(vdiff-change-face ((,class :inherit autumn-themes-diff-changed)))
    `(vdiff-closed-fold-face ((,class :inherit autumn-themes-diff-heading)))
    `(vdiff-refine-added ((,class :inherit autumn-themes-diff-refine-added)))
    `(vdiff-refine-changed ((,class :inherit autumn-themes-diff-refine-changed)))
    `(vdiff-subtraction-face ((,class :inherit autumn-themes-diff-removed)))
    `(vdiff-target-face ((,class :inherit autumn-themes-intense-blue)))
;;;;; vertico
...
;;;;; vimish-fold
    ...
    `(vimish-fold-mouse-face ((,class :inherit autumn-themes-intense-blue)))
...
;;;;; visual-regexp
    `(vr/group-0 ((,class :inherit autumn-themes-intense-blue)))
    `(vr/group-1 ((,class :inherit autumn-themes-intense-magenta)))
    `(vr/group-2 ((,class :inherit autumn-themes-intense-green)))
    `(vr/match-0 ((,class :inherit autumn-themes-refine-yellow)))
    `(vr/match-1 ((,class :inherit autumn-themes-refine-yellow)))
    `(vr/match-separator-face ((,class :inherit (autumn-themes-intense-neutral bold))))
;;;;; volatile-highlights
...
;;;;; web-mode
    ...
    `(web-mode-current-element-highlight-face ((,class :inherit autumn-themes-special-mild)))
    `(web-mode-doctype-face ((,class :inherit autumn-themes-slant :foreground ,fg-special-cold)))
    `(web-mode-error-face ((,class :inherit autumn-themes-intense-red)))
...
;;;;; wgrep
    `(wgrep-delete-face ((,class :inherit autumn-themes-refine-yellow)))
    `(wgrep-done-face ((,class :inherit autumn-themes-refine-blue)))
    `(wgrep-face ((,class :inherit autumn-themes-refine-green)))
    `(wgrep-file-face ((,class :foreground ,fg-special-warm)))
    `(wgrep-reject-face ((,class :inherit (autumn-themes-intense-red bold))))
;;;;; which-function-mode
...
;;;;; which-key
    ...
    `(which-key-key-face ((,class :inherit autumn-themes-key-binding)))
...
;;;;; whitespace-mode
    `(whitespace-big-indent ((,class :inherit autumn-themes-subtle-red)))
    `(whitespace-empty ((,class :inherit autumn-themes-intense-magenta)))
    ...
    `(whitespace-line ((,class :inherit autumn-themes-subtle-yellow)))
    ...
    `(whitespace-space-after-tab ((,class :inherit autumn-themes-subtle-magenta)))
    `(whitespace-space-before-tab ((,class :inherit autumn-themes-subtle-cyan)))
    `(whitespace-tab ((,class :background ,bg-whitespace :foreground ,fg-whitespace)))
    `(whitespace-trailing ((,class :inherit autumn-themes-intense-red)))
;;;;; window-divider-mode
...
;;;;; winum
    `(winum-face ((,class :inherit autumn-themes-bold :foreground ,cyan-active)))
;;;;; writegood-mode
    `(writegood-duplicates-face ((,class :background ,bg-alt :foreground ,red-alt :underline t)))
    `(writegood-passive-voice-face ((,class :inherit autumn-themes-lang-warning)))
    `(writegood-weasels-face ((,class :inherit autumn-themes-lang-error)))
;;;;; woman
...
;;;;; yaml-mode
    `(yaml-tab-face ((,class :inherit autumn-themes-intense-red)))
;;;;; yasnippet
...
;;;;; ztree
    ...
    `(ztreep-diff-model-add-face ((,class :foreground ,@(autumn-themes--diff-deuteran blue green))))
  ...
  "Face specs for use with `autumn-themes-theme'.")

(defconst autumn-themes-custom-variables
  '(
;;;; ansi-colors
...
;;;; flymake fringe indicators
    `(flymake-error-bitmap '(flymake-double-exclamation-mark autumn-themes-fringe-red))
    `(flymake-warning-bitmap '(exclamation-mark autumn-themes-fringe-yellow))
    `(flymake-note-bitmap '(exclamation-mark autumn-themes-fringe-cyan))
;;;; ibuffer
    `(ibuffer-deletion-face 'autumn-themes-mark-del)
    `(ibuffer-filter-group-name-face 'autumn-themes-pseudo-header)
    `(ibuffer-marked-face 'autumn-themes-mark-sel)
...
;;;; xterm-color
    ...
    (if (or (eq autumn-themes-org-blocks 'tinted-background)
            (eq autumn-themes-org-blocks 'rainbow))
        `(org-src-block-faces              ; TODO this list should be expanded
          `(("emacs-lisp" autumn-themes-nuanced-magenta)
            ("elisp" autumn-themes-nuanced-magenta)
            ("clojure" autumn-themes-nuanced-magenta)
            ("clojurescript" autumn-themes-nuanced-magenta)
            ("c" autumn-themes-nuanced-blue)
            ("c++" autumn-themes-nuanced-blue)
            ("sh" autumn-themes-nuanced-green)
            ("shell" autumn-themes-nuanced-green)
            ("html" autumn-themes-nuanced-yellow)
            ("xml" autumn-themes-nuanced-yellow)
            ("css" autumn-themes-nuanced-red)
            ("scss" autumn-themes-nuanced-red)
            ("python" autumn-themes-nuanced-green)
            ("ipython" autumn-themes-nuanced-magenta)
            ("r" autumn-themes-nuanced-cyan)
            ("yaml" autumn-themes-nuanced-cyan)
            ("conf" autumn-themes-nuanced-cyan)
            ("docker" autumn-themes-nuanced-cyan)))
      `(org-src-block-faces '())))
  "Custom variables for `autumn-themes-theme'.")
